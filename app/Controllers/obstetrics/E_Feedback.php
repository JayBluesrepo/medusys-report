...
{ 
    ...
    {   
        ...
        // if($dr_id){        
            ...
            $href = 'https://medusys.in/public/obstetrics/E_Feedback/view_feedback?id='.$pass.'';           
            ...
            if($email->send()){
                $efModel = new obstetrics_EFeedbackModel();
                $data = [
                    'track' => $pass,
                    'flag'  => 1,
    ...
    public function view_feedback()
    {
        ...
        // if($dr_id){        
            ...
            return view('obstetrics/e-feedback', $data);
        // }else{
        //     return view('login');
        // }
    }
    public function show_feedback()
    {
        ...
        // if($dr_id){        
            ...
            $model1 = new obstetrics_EFeedbackModel(); 
            ...
            return view('obstetrics/e-feedbackdetails',$data);
        // }else{
        //     return view('login');
        // }
    }
    ...
    public function add_efeed(){
        ...
        if($data){
            $efeedModel = new obstetrics_EFeedbackModel(); 
