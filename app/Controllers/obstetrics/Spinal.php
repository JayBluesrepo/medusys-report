...
class Spinal extends BaseController
{
    public function index()
    {
        ...
        if($dr_id){        
            ...
            $model1 = new obstetrics_SpinalModel(); 
            ...
            if(!empty($detail)){
                return view('obstetrics/spinaldetails',$data);
            }else{
                return view('obstetrics/spinal',$data);
            } 
        }else{
            return view('login');
        }
    ...
    public function add_spin(){
        ...
        $ultrasound1 = $this->request->getVar('ultrasoun');
        ...
        $spinModel = new obstetrics_SpinalModel();        
        $spinModel->save($spinData);
        $insertedID = $spinModel->insertID();
        if($insertedID){
            return json_encode(array(
                'result'    => 1,
                'message'   => 'Spinal data Added Successfully.....',
                'msg' => $insertedID
            ));
       }
       else{
