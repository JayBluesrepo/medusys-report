...
class Epidural extends BaseController
{
    use ResponseTrait;
    ...
    public function index()
    {
        ...
        if($dr_id){        
            ...
            $model2 = new obstetrics_EpiduralModel(); 
            ...
            if(!empty($detail)){
                return view('obstetrics/epidetails',$data);
            }else{
                return view('obstetrics/epidural',$data);
            }  
        }else{
            return view('login');
        }   
    ...
    public function add_epi(){
        ...
        $epidural_in_situ = $this->request->getVar('epidural_in_situ');
        ...
        // print_r($epidural_in_situ);die();

        if($epidural_in_situ == 'No'){

            $epiData = array(
                'patient_id'=>$patient_id,
                'epidural_in_situ'=>$epidural_in_situ,
        ...
        if($insertedID){
            return json_encode(array(
                'result'    => 1,
                'message'   => 'Epidural data Added Successfully.....',
                'msg' => $insertedID
            ));
       }
       else{
