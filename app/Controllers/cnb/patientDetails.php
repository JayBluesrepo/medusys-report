...
{   
    ...
    public function index()
    {
        ...
        if($dr_id){       
            ...
            return view('cnb/patient_details',$data);
            // print_r($data);die();
        }else{
            return view('login');
        }
