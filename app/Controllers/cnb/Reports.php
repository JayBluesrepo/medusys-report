...
public function procedure_success() {  
	...
	// --------------------EPIDURAL-------------------
			...
			return redirect()->route("n_report");
		}
...
public function n_report() {
   ...
   //------------------------ procedure---------------//
		...
		$total = session()->get('n');
			...
			if($record){
				foreach($record as $row) {
					...
					else if(substr($row->patient_status,0,8) == 'Sedation'){
							$sedation = $sedation + 1;
					}
    ...
    public function anatomical() {  
		...
		$data['total'] = $landmark1 + $landmark2 + $landmark3; 
		$data['total_n'] = $landmark1 + $landmark2 + $landmark3;     
		//$query = $db->getLastQuery();
...
// echo $query;
			...
			if($record){
				foreach($record as $row) {
					echo $row->ultra_sound;
					if($row->ultra_sound == 'Yes'){
							$yes = $yes + 1; 
							$total_num = $total_num  + 1;
					}
					else if($row->ultra_sound == 'No'){
							$no = $no + 1;
							echo 'no';
							$total_num = $total_num  + 1;
					}
			...
			if($record){
				foreach($record as $row) {
					if($row->needle_brand == 'B-Braun'){
							$B_Braun = $B_Braun + 1;
					}
					else if($row->needle_brand == 'Vygon'){
							$Vygon = $Vygon + 1;
					}
					else if($row->needle_brand == 'Polymed'){
							$Polymed = $Polymed + 1;
					}
					else if($row->needle_brand == 'Portex'){
							$Portex = $Portex + 1;
					}
					else if($row->needle_brand == 'Top'){
							$Top = $Top + 1;
					}
					else if($row->needle_brand == 'BD'){
							$BD = $BD + 1;
					}
					else if($row->needle_brand == 'Pajunk'){
							$Pajunk = $Pajunk + 1;
					}
					else if($row->needle_brand == 'Romsons'){
							$Romsons = $Romsons + 1;
					}
					else if(substr($row->needle_brand,0,4) == 'Other'){
							$Other = $Other + 1;
					}
	        ...
	        $data['total'] = $B_Braun + $Vygon + $Polymed + $Portex + $Top + $BD + $Pajunk + $Romsons + $Other; 
	        $data['total_n'] =  $B_Braun + $Vygon + $Polymed + $Portex + $Top + $BD + $Pajunk + $Romsons + $Other; 
...
<<<<<<< HEAD
						...
						$csa_vasopressor=number_format((float)(($cse_vasopressor/$total)*100), 1, '.', '')."%";
...
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
						...
						$csa_vasopressor_total=number_format((float)(($cse_vasopressor_total/$total)*100), 1, '.', '')."%";
					}
				}
...
<<<<<<< HEAD
						...
						$s_vasopressor=number_format((float)(($s_vasopressor/$total)*100), 1, '.', '')."%";
=======
						$s_vasopressor=number_format((float)$row->s_vasopressor, 2, '.', '');
...
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
						...
						$s_vasopressor_total=number_format((float)(($s_vasopressor_total/$total)*100), 1, '.', '')."%";
					}
				}
...
<<<<<<< HEAD
						...
						$e_vasopressor=number_format((float)(($e_vasopressor/$total)*100), 1, '.', '')."%";
=======
						$e_vasopressor=number_format((float)$row->e_vasopressor, 2, '.', '');
...
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
						...
						$e_vasopressor_total=number_format((float)(($e_vasopressor_total/$total)*100), 1, '.', '')."%";
					}
				}
				...
				$products[] = array( 
					...
					'cse' => number_format((float)(($cse_vasopressor/$total)*100), 1, '.', '')."%",
					'epidural' => number_format((float)(($e_vasopressor/$total)*100), 1, '.', '')."%",
					'spinal' => number_format((float)(($s_vasopressor/$total)*100), 1, '.', '')."%",
					'csa' => number_format((float)(($csa_vasopressor/$total)*100), 1, '.', '')."%",
				);
...
// print_r($total);die();
			...
			if($record){
				foreach($record as $row) {
					if($row->nvs_postproc >= 0 && $row->nvs_postproc  <=4){
							$nvs_postproc1 = $nvs_postproc1 + 1;
					}
					else if($row->nvs_postproc >= 5 && $row->nvs_postproc <=7){
							$nvs_postproc2 = $nvs_postproc2 + 1;
					}
					else if($row->nvs_postproc >= 8 && $row->nvs_postproc <=10){
							$nvs_postproc3 = $nvs_postproc3 + 1;
					}
					else if($row->nvs_postproc == 'Unable to score'){
							$nvs_postproc4 = $nvs_postproc4 + 1;
					}
				}
			}
			...
			if($record){
				foreach($record as $row) {
					if($row->nvs_30mins >= 0 && $row->nvs_30mins  <=4){
							$nvs_30mins1 = $nvs_30mins1 + 1;
					}
				
					else if($row->nvs_30mins >= 5 && $row->nvs_30mins <=7){
							$nvs_30mins2 = $nvs_30mins2 + 1;
					}
					else if($row->nvs_30mins >=8 && $row->nvs_30mins <=10){
							$nvs_30mins3 = $nvs_30mins3 + 1;
					}
					else if($row->nvs_30mins == 'Unable to score'){
			...
			if($record){
				foreach($record as $row) {
					if($row->nvs_1hr >= 0 && $row->nvs_1hr  <=4){
							$nvs_1hr1 = $nvs_1hr1 + 1;
					}
				
					else if($row->nvs_1hr >= 5 && $row->nvs_1hr <=7){
							$nvs_1hr2 = $nvs_1hr2 + 1;
					}
					else if($row->nvs_1hr >=8 && $row->nvs_1hr <=10){
							$nvs_1hr3 = $nvs_1hr3 + 1;
					}
					else if($row->nvs_1hr == 'Unable to score'){
							$nvs_1hr4 = $nvs_1hr4 + 1;
					}
				}	
			}
     ...
     public function Sedation_Scores() {  
		...
		if($from_date && $to_date){
			...
			$builder = $db->table('cnb_postop');
			$query = $builder->select("cnb_postop.ss_postproc,cnb_postop.ss_30mins,cnb_postop.ss_1hr");
			$query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
			$query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
			$query = $builder->get();
			$record = $query->getResult();
     ...
     public function Analgesia() {  
			...
			$builder = $db->table('cnb_postop');
		    $query = $builder->select("cnb_postop.id as count, cnb_postop.intravenous_opioids,cnb_postop.oral_opioids,cnb_postop.tramadol,cnb_postop.nsaid,cnb_postop.paracetamol,cnb_postop.la_regimen,cnb_postop.other,cnb_postop.repeat");
...
// epidural_name
    ...
    public function Approach() {  
       ...
       $from_date = session()->get('from_date');
		...
		$data['total'] = $approach1 + $approach2; 
		$data['total_n'] = $total;       
...
<<<<<<< HEAD
			    ...
			    // $query = $builder->select("AVG(procedure_csa.no_attempts) as average, STDDEV(procedure_csa.no_attempts) as std");

			    $query = $builder->join('procedure_csa', 'procedure_csa.patient_id = cnb_postop.patient_id');
...
=======
				...
				$builder = $db->table('cnb_postop');
			    $query = $builder->select("AVG(procedure_csa.no_attempts)as csa_average, STDDEV(procedure_csa.no_attempts) as csa_std, cnb_postop.id as count, procedure_csa.anatomical_landmark,procedure_csa.approach,procedure_csa.no_attempts");
			    $builder->join('procedure_csa', 'procedure_csa.patient_id = cnb_postop.patient_id');
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
			    $query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
			    $query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
...
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
				...
				$builder = $db->table('cnb_postop');
<<<<<<< HEAD
			    // $query = $builder->select("AVG(procedure_cse.no_attempts) as average, STDDEV(procedure_cse.no_attempts) as std");
...
=======
			    ...
			    // $query = $builder->select("AVG(procedure_csa.no_attempts)as cseAverage, STDDEV(procedure_csa.no_attempts) as cseStd, cnb_postop.id as count, procedure_csa.anatomical_landmark,procedure_csa.approach,procedure_csa.no_attempts");


			    $query = $builder->select("AVG(procedure_cse.no_attempts)as cse_Average, STDDEV(procedure_cse.no_attempts) as cse_Std,cnb_postop.id as count, procedure_cse.anatomical_landmark,procedure_cse.approach,procedure_cse.no_attempts");
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
			    $builder->join('procedure_cse', 'procedure_cse.patient_id = cnb_postop.patient_id');
			    $query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
			    $query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
...
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
				...
				$builder = $db->table('cnb_postop');
<<<<<<< HEAD
			    // $query = $builder->select("AVG(procedure_spinal.no_attempts) as average, STDDEV(procedure_spinal.no_attempts) as std");
...
=======
			    $query = $builder->select("AVG(procedure_spinal.no_attempts)as spinal_Average, STDDEV(procedure_spinal.no_attempts) as spinal_Std,cnb_postop.id as count, procedure_spinal.anatomical_landmark,procedure_spinal.approach,procedure_spinal.no_attempts");
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
			    $builder->join('procedure_spinal', 'procedure_spinal.patient_id = cnb_postop.patient_id');
			    $query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
			    $query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
...
=======
						$avg_spinal +=  $row->spinal_Average;
						$total_spinal +=  $row->no_attempts;
						$std_spinal +=  $row->spinal_Std;
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
					}
				}
...
=======
			    $query = $builder->select("AVG(procedure_epidural.no_attempts)as epidural_Average, STDDEV(procedure_epidural.no_attempts) as epidural_Std,cnb_postop.id as count, procedure_epidural.anatomical_landmark,procedure_epidural.approach,procedure_epidural.no_attempts");
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
			    $builder->join('procedure_epidural', 'procedure_epidural.patient_id = cnb_postop.patient_id');
			    $query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
			    $query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
...
=======
						$avg_epidural +=  $row->epidural_Average;
						$total_epidural +=  $row->no_attempts;
						$std_epidural +=  $row->epidural_Std;
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
					}
				}
...
=======
		$data['total_n'] = $total_cse + $total_csa + $total_spinal + $total_csa;      
>>>>>>> 5713fa5e7035f572fd24a29a7a543674a2d64346
...
//die();
      ...
      if($record){
        foreach($record as $row) {
        	$combo = 0; 
			if(substr($row->la_ropivacaine, 0,7)  == "Without"){
				$la_ropivacaine = $la_ropivacaine + 1;
				$combo = $combo + 1;
			}
			else if(substr($row->la_ropivacaine, 0,4) == 'With'){
				$la_ropivacaine1 = $la_ropivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_bupivacaine, 0,7)  == "Without"){
				$la_bupivacaine = $la_bupivacaine + 1;
				$combo = $combo + 1;
			}
			else if(substr($row->la_bupivacaine, 0,4) == 'With'){
				$la_bupivacaine1 = $la_bupivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_levobupivacaine, 0,7)  == "Without"){
				$la_levobupivacaine = $la_levobupivacaine + 1;
				$combo = $combo + 1;

			}
			else if(substr($row->la_levobupivacaine, 0,4) == 'With'){
				$la_levobupivacaine1 = $la_levobupivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_lignocaine, 0,7)  == "Without"){
				$la_lignocaine = $la_lignocaine + 1; 
				$combo = $combo + 1;
			}
			else if(substr($row->la_lignocaine, 0,4) == 'With'){
     ...
     // die();
      ...
      $data['total_n'] = $la_ropivacaine + $la_bupivacaine  + $la_levobupivacaine +$la_lignocaine;
      $data['total_n1'] =  $la_ropivacaine1 + $la_bupivacaine1  + $la_levobupivacaine1 +$la_lignocaine1;
...
// print_r($total);die();
      ...
      $la_otheraine1 = 0;
        ...
        $builder = $db->table('cnb_postop');
        $query = $builder->select("cnb_postop.id as count,procedure_spinal.la_ropivacaine,procedure_spinal.la_bupivacaine,procedure_spinal.la_prilocaine,procedure_spinal.la_lignocaine,procedure_spinal.la_otheraine,procedure_spinal.la_2_chloroprocaine");
        $builder->join('procedure_spinal', 'procedure_spinal.patient_id = cnb_postop.patient_id');
        $query = $builder->where('cnb_postop.procedure_date >=',date('Y-m-d',strtotime($from_date)));
        $query = $builder->where('cnb_postop.procedure_date <=',date('Y-m-d',strtotime($to_date)));
        $query = $builder->get();
...
// echo $query; 
      ...
      if($record){
        foreach($record as $row) {
        	$combo = 0; 
			if(substr($row->la_ropivacaine, 0,5)  == "Heavy"){
				$la_ropivacaine = $la_ropivacaine + 1;
				$combo = $combo + 1;
			}
			else if(substr($row->la_ropivacaine, 0,13) == 'Iso/Hypobaric'){
				$la_ropivacaine1 = $la_ropivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_bupivacaine, 0,5)  == "Heavy"){
				$la_bupivacaine = $la_bupivacaine + 1;
				$combo = $combo + 1;
			}
			else if(substr($row->la_bupivacaine, 0,13) == 'Iso/Hypobaric'){
				$la_bupivacaine1 = $la_bupivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_levobupivacaine,0,5)  == "Heavy"){
				$la_levobupivacaine = $la_levobupivacaine + 1;
				$combo = $combo + 1;
			}
			else if(substr($row->la_levobupivacaine,0,13) == 'Iso/Hypobaric'){
				$la_levobupivacaine1 = $la_levobupivacaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_lignocaine, 0,5)  == "Heavy"){
				$la_lignocaine = $la_lignocaine + 1; 
				$combo = $combo + 1;
			}
			else if(substr($row->la_lignocaine, 0,13) == 'Iso/Hypobaric'){
				$la_lignocaine1 = $la_lignocaine1 + 1;
				$combo = $combo + 1;
			}

			if(substr($row->la_otheraine, 0,5)  == "Heavy"){
				$la_otheraine = $la_otheraine + 1; 
				$combo = $combo + 1;
			}
			else if(substr($row->la_otheraine, 0,13) == 'Iso/Hypobaric'){
				$la_otheraine1 = $la_otheraine1 + 1;
				$combo = $combo + 1;
			}
			if(substr($row->la_2_chloroprocaine, 0,5)  == "Heavy"){
				$la_2_chloroprocaine = $la_2_chloroprocaine + 1; 
				$combo = $combo + 1;
			}
			else if(substr($row->la_2_chloroprocaine, 0,13) == 'Iso/Hypobaric'){
...
$builder = $db->table('cnb_postop');
      ...
      $data['total_n'] = $la_ropivacaine + $la_bupivacaine  + $la_levobupivacaine +$la_lignocaine + $$la_2_chloroprocaine + $la_otheraine;
      $data['total_n1'] =  $la_ropivacaine1 + $la_bupivacaine1  + $la_levobupivacaine1 +$la_lignocaine1+$la_2_chloroprocaine1 + $la_otheraine1;
...
// Rahul
    ...
    public function epidural_adjuvant() {
		...
		if($from_date && $to_date){$total11 = 0;
			$total12 = 0;
			$all_total1 = 0;
			$builder = $db->table('procedure_epidural');
	...
	public function component_adjuvant() {
		...
		if($record){
			...
			$data['products'] = $products;
			$data['total'] = $total;
		return view('cnb/reports/component_adjuvant_v', $data);   
   ...
   public function safety() {  
     ...
     public function surgery() {  
		...
		if($from_date && $to_date){
			...
			$data['total'] = $total;   
			return view('cnb/reports/surgery', $data);
		...
		public function Epidural_Component_Single_Dose() {  
		...
		return view('cnb/reports/epidural_component_single_dose', $data);      
		
	}else{
		return redirect()->route("n_report");
	}
    }
		public function Epidural_Component_Sala_Dose() {  
		...
		return view('cnb/reports/epidural_component_sala_dose', $data);      
		
	}else{
		return redirect()->route("n_report");
	}
    }
		public function Spinal_Component_Single_Dose() {  
		...
		return view('cnb/reports/Spinal_Component_Single_Dose', $data);      
	...
	public function Spinal_Component_Combo_Dose() {  
		...
		return view('cnb/reports/Spinal_Component_Combo_Dose', $data);      
		
	}else{
		return redirect()->route("n_report");
	}
    }
	public function Epidural_Single_Dose() {  
		...
		return view('cnb/reports/Epidural_Single_Dose', $data);      
		...
		return view('cnb/reports/Epidural_Sala_Combo_Dose', $data);      
		
	}else{
		return redirect()->route("n_report");
	}
    }
	public function Spinal_Dose() {  
		...
		return view('cnb/reports/Spinal_Dose', $data);      
		
	}else{
		return redirect()->route("n_report");
	}
    }
		public function Spinal_Combo_Dose() {  
		...
		return view('cnb/reports/Spinal_Combo_Dose', $data);      
		...
		return view('cnb/reports/csa_Component_single_Dose', $data);      
