...
{   
    ...
    {   
        ...
        if($dr_id){       
            ...
            $model2 = new combinedSpinalEpiduralModel(); 
            ...
            if(!empty($detail)){
                return view('cnb/combined-spinal-view',$data);
            }else{
                return view('cnb/combined_spinal_epidural',$data);
            }  
        }else{
            return view('login');
        }
    ...
    public function add_combined_procedure(){
        ...
        // print_r($epidural_other);
        // print_r($asr_name_dose);   
        // // var_dump($epidural_other);   
        // die();

        $tc_failure_spinal_component = $this->request->getVar('tc_failure_spinal_component');
       
        $ac_intrathecal_epi_catheter = $this->request->getVar('ac_intrathecal_epi_catheter');
        ...
        $combined_details = array(
            'failure_spinal_compo'=>$tc_failure_spinal_component,


            'ac_intrathecal_epi_catheter'=>$ac_intrathecal_epi_catheter,
        ...
        // print_r($_POST);
        // print_r($combined_details);
        // die();
        
        $adding_combined_details = new combinedSpinalEpiduralModel();
