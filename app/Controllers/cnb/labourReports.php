...
class labourReports extends ResourceController
{
    ...
    public function labour_reports_home() {

    	$name = session()->get('name');

        return view('cnb/labourReports/labour_cnb-reports');  
		               
    }

     public function labour_z(){
...
// print_r($audit);die();
	...
	public function labour_n_report() {
		...
		if($from_date == '' && $to_date == ''){
			 return view('includes/labour-reports-date-header'); 
		}
	...
	// print_r($s_total);die();
			...
			return view('cnb/labourReports/labour_n_report', $data);
			}    
...
public function labour_procedure_success() {  
	...
	// --------------------EPIDURAL-------------------
			...
			return view('cnb/labourReports/labour_procedure_success', $data);             
		
	}
	else{
			return redirect()->route("labour-n-report");
		}


    }
	public function labour_asa() {  
        $db = \Config\Database::connect();
        ...
        if($from_date && $to_date  && $n_type != 'NULL'){
			...
			if($record){
				...
				return view('cnb/labourReports/labour_asa_v', $data);
		}
		else{
				return redirect()->route("labour-n-report");
			}
}
    public function labour_demography() {
		...
		return view('cnb/labourReports/labour_demography_v', $data);       
...
public function labour_late_complication() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_late_complication_v', $data);              
    ...
    public function labour_bar() {
		...
		return view('cnb/labourReports/labour_bar', $data); 
   ...
   //------------------------ procedure---------------//
      ...
      public function labour_surgical() {  
		...
		return view('cnb/labourReports/labour_surgical_v', $data);                

	}else{
		return redirect()->route("labour-n-report");
	}
    }
    public function labour_speciality() {  
        ...
        if($from_date && $to_date  && $n_type != 'NULL'){
			...
			if($record){
				...
				return view('cnb/labourReports/labour_speciality_v', $data);
		}
		else{
				return redirect()->route("labour-n-report");
			}
    }
    public function labour_location() {  
        ...
        if($from_date && $to_date  && $n_type != 'NULL'){
			...
			if($record){
				...
				return view('cnb/labourReports/labour_location_v', $data);
		}
		else{
				return redirect()->route("labour-n-report");
			}
    }
    public function labour_purpose() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			return view('cnb/labourReports/labour_purpose_v', $data);      
    ...
    public function labour_consultant() {  
		...
		return view('cnb/labourReports/labour_consultant_v', $data);         
    ...
    public function labour_patient_status() {  
		...
		$total = session()->get('n');
			...
			return view('cnb/labourReports/labour_patient_status_v', $data);    
     ...
     public function labour_sterility_features() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_sterility_features_v', $data);              
    ...
    public function labour_anatomical() {  
		...
		return view('cnb/labourReports/labour_anatomical_v', $data);               
    ...
    public function labour_ultra_sound() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			return view('cnb/labourReports/labour_ultra_sound_v', $data);        
       	 ...
       	 public function labour_needle_brand() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_needle_brand_v', $data);              
		}else{
		return redirect()->route("labour-n-report");
	}	
	...
	public function labour_cse_technique() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			return view('cnb/labourReports/labour_cse_technique_v', $data);       
		}
		else{
			return redirect()->route("labour-n-report");
		}
	...
	public function labour_csa_technique() {  
		...
		$total = session()->get('n');
			...
			return view('cnb/labourReports/labour_csa_technique_v', $data);       
	...
	public function labour_stay_duration() {  
		...
		return view('cnb/labourReports/labour_stay_duration_v', $data);       
...
//3.1 started
  //   public function Procedure_Outcomes() {  
		...
		// return view('cnb/labourReports/labour_Procedure_Outcomes_v', $data);                
  //   }

  public function labour_technical_problems() {  
...
//            ------------------------------SPINAL-------------------
		...
		$data['products'] = $products;
		$data['total'] = $total;
		return view('cnb/labourReports/labour_technical-problems_v', $data);                            
   ...
   public function labour_acute_problems() {  
		...
		return view('cnb/labourReports/labour_acute_problems_v', $data);        
    ...
    public function labour_OP_Analgesia() {  
		...
		if($from_date && $to_date){
			...
			return view('cnb/labourReports/labour_OP_Analgesia_v', $data);        
     ...
     public function labour_IV_Supplements() {  
		...
		return view('cnb/labourReports/labour_IV_Supplements_v', $data);      
     ...
     public function labour_Outcome_characteristics() {  
		...
		return view('cnb/labourReports/labour_Outcome_characteristics_v', $data);    
     ...
     public function labour_Pain_Score() {  
...
if($from_date && $to_date){
			...
			if($record){
				foreach($record as $row) {
					if($row->ps_postproc >= 0 && $row->ps_postproc  <=4){
							$a1 = $a1 + 1;
					}
				
					else if($row->ps_postproc >= 5 && $row->ps_postproc <=7){
							$a2 = $a2 + 1;
					}
					else if($row->ps_postproc >=8 && $row->ps_postproc <=10){
							$a3 = $a3 + 1;
					}
					else if($row->ps_postproc == 'Unable to score'){
							$a4 = $a4 + 1;
					}
				}
			}
			...
			if($record){
				foreach($record as $row) {
					if($row->ps_30mins >= 0 && $row->ps_30mins  <=4){
							$ps_30mins1 = $ps_30mins1 + 1;
					}
				
					else if($row->ps_30mins >= 5 && $row->ps_30mins <=7){
							$ps_30mins2 = $ps_30mins2 + 1;
					}
					else if($row->ps_30mins >=8 && $row->ps_30mins <=10){
							$ps_30mins3 = $ps_30mins3 + 1;
					}
					else if($row->ps_30mins == 'Unable to score'){
							$ps_30mins4 = $ps_30mins4 + 1;
					}
				}	
			}
			...
			if($record){
				foreach($record as $row) {
					if($row->ps_1hr >= 0 && $row->ps_1hr  <= 4){
							$ps_1hr1 = $ps_1hr1 + 1;
					}
					else if($row->ps_1hr >= 5 && $row->ps_1hrs <= 7){
							$ps_1hr2 = $ps_1hr2 + 1;
					}
					else if($row->ps_1hr >= 8 && $row->ps_1hr <= 10){
							$ps_1hr3 = $ps_1hr3 + 1;
					}
					else if($row->ps_1hr == 'Unable to score'){
							$ps_1hr4 = $ps_1hr4 + 1;
					}
				}	
			}
		...
		// $data['products2'] = ($products2);
	        ...
	        $data['total_n'] = $total; 
// print_r('hellp');
			return view('cnb/labourReports/labour_Pain_Score_v', $data);     
...
// print_r($total);die();
			...
			if($record){
				foreach($record as $row) {
					if($row->$nvs_postproc1 >= 0 && $row->nvs_postproc  <=4){
							$nvs_postproc = $nvs_postproc + 1;
					}
				
					else if($row->$nvs_postproc2 >= 5 && $row->nvs_postproc <=7){
							$nvs_postproc = $nvs_postproc + 1;
					}
					else if($row->$nvs_postproc3 >=8 && $row->nvs_postproc <=10){
							$nvs_postproc = $nvs_postproc + 1;
					}
					else if($row->unable == 'Unable to score'){
						$nvs_postproc = $nvs_postproc + 1;
				}
				}
			}
			...
			if($record){
				foreach($record as $row) {
					if($row->$nvs_30mins1 >= 0 && $row->nvs_30mins  <=4){
							$nvs_30mins1 = $nvs_30mins1 + 1;
					}
				
					else if($row->$nvs_30mins2 >= 5 && $row->nvs_30mins <=7){
							$nvs_30mins2 = $nvs_30mins2 + 1;
					}
					else if($row->$nvs_30mins3 >=8 && $row->nvs_30mins <=10){
							$nvs_30mins3 = $nvs_30mins3 + 1;
					}
					else if($row->$nvs_30mins4 == 'Unable to Score'){
						$nvs_30mins4 = $nvs_30mins4 + 1;
				}
				}	
			}
			...
			if($record){
				foreach($record as $row) {
					if($row->$nvs_1hr1>= 0 && $row->nvs_1hr1  <=4){
							$nvs_1hr1 = $nvs_1hr + 1;
					}
				
					else if($row->$nvs_1hr2 >= 5 && $row->nvs_1hr2 <=7){
							$nvs_1hr2 = $nvs_1hr2 + 1;
					}
					else if($row->$nvs_1hr3 >=8 && $row->nvs_1hr3 <=10){
							$nvs_1hr3 = $nvs_1hr3 + 1;
					}
					else if($row->$nvs_1hr4 =='unable to score'){
						$nvs_1hr4 = $nvs_1hr4 + 1;
				}
				}	
			}
		...
		// $data['products2'] = ($products2);
			...
			return view('cnb/labourReports/labour_Nausea_v', $data);       
     ...
     public function labour_Sedation_Scores() {  
		...
		if($from_date && $to_date){
			...
			if($record){
				foreach($record as $row) { 
					...
					if($row->ss_postproc == '0-Awake'){
						$a1 = $a1 + 1;
						
					}

					else if($row->ss_postproc == '1-Mild, easy to rouse'){
						$a2 = $a2 + 1;
						
					}
					else if($row->ss_postproc == '2-Moderate, easy to rouse, unable to remain'){
						$a3 = $a3 + 1;
						
					}
					else if($row->ss_postproc == '3-Difficult to rouse'){
						$a4 = $a4 + 1;
						
					}
					else if($row->ss_postproc == 'Unable to score'){
						$a5 = $a5 + 1;
					}


					if($row->ss_30mins == '0-Awake'){
						$b1 = $b1 + 1;
						
					}
					else if($row->ss_30mins == '1-Mild, easy to rouse'){
						$b2 = $b2 + 1;
						
					}
					else if($row->ss_30mins == '2-Moderate, easy to rouse, unable to remain'){
						$b3 = $b3 + 1;
						
					}
					else if($row->ss_30mins == '3-Difficult to rouse'){
						$b4 = $b4 + 1;
						
					}
					else if($row->ss_30mins == 'Unable to score'){
						$b5 = $b5 + 1;
						
					}

					if($row->ss_1hr == '0-Awake'){
						$c1 = $c1 + 1;
						
					}
					else if($row->ss_1hr == '1-Mild, easy to rouse'){
						$c2 = $c2 + 1;
						
					}
					else if($row->ss_1hr == '2-Moderate, easy to rouse, unable to remain'){
						$c3 = $c3 + 1;
						
					}
					else if($row->ss_1hr == '3-Difficult to rouse'){
						$c4 = $c4 + 1;
						
					}
					else if($row->ss_1hr == 'Unable to score'){
						$c5 = $c5 + 1;
			...
			$products[] = array(
				'day'   => '2-Moderate, easy to rouse, unable to remain',
				'sell' => $a3,
				'sell1' => $b3,
				'sell2' => $c3
			);
			...
			return view('cnb/labourReports/labour_Sedation_Scores_v', $data); 
     ...
     public function labour_Recovery() {  
		...
		$builder = $db->table('cnb_postop');
	    $query = $builder->select("COUNT(cnb_postop.id) as count,STDDEV(cnb_postop.time_spent) as std,AVG(cnb_postop.time_spent) as avg");
	    $builder->join('procedure_csa', 'procedure_csa.patient_id = cnb_postop.patient_id');
	    $query = $builder->where('procedure_csa.procedure_date >=',date('Y-m-d',strtotime($from_date)));
	    $query = $builder->where('procedure_csa.procedure_date <=',date('Y-m-d',strtotime($to_date)));
	    $query = $builder->get();
		...
		foreach($record as $row) {
			...
			$total += floatval($row->count);
			$csa_total_std = floatval($row->std);
			$csa_total_avg = floatval($row->avg);
		}
		...
		foreach($record as $row) {
			$total += floatval($row->count);
			$epidural_total_std = floatval($row->std);
			$epidural_total_avg = floatval($row->avg);
		}
		...
		foreach($record as $row) {
			$total += floatval($row->count);
			$spinal_total_std = floatval($row->std);
			$spinal_total_avg = floatval($row->avg);
		}
		...
		foreach($record as $row) {
			$total += floatval($row->count);
			$cse_total_std = floatval($row->std);
			$cse_total_avg = floatval($row->avg);
		}
		// $data['products'] = ($products);
		...
		$csa_total_std = number_format((float)$csa_total_std, 2, '.', '');
		$epidural_total_std = number_format((float)$epidural_total_std, 2, '.', '');
		$spinal_total_std = number_format((float)$spinal_total_std, 2, '.', '');
		$cse_total_std = number_format((float)$cse_total_std, 2, '.', '');

		$csa_total_avg = number_format((float)$csa_total_avg, 2, '.', '');
		$epidural_total_avg = number_format((float)$epidural_total_avg, 2, '.', '');
		$spinal_total_avg = number_format((float)$spinal_total_avg, 2, '.', '');
		$cse_total_avg = number_format((float)$cse_total_avg, 2, '.', '');

		$t_std = $csa_total_std + $epidural_total_std + $spinal_total_std + $cse_total_std;
		//$t_std = ($t_std/4);

		$t_avg = $csa_total_avg + $epidural_total_avg + $spinal_total_avg + $cse_total_avg;
		//$t_avg = ($t_avg/4);
		...
		$time_spent[] = array(
			'day'   => 'CSE',
			'sell' => "(".$csa_total_std."±".$csa_total_avg.")"
		);

		$time_spent[] = array(
			'day'   => 'Epidural',
			'sell' => "(".$epidural_total_std."±".$epidural_total_avg.")"
		);
		$time_spent[] = array(
			'day'   => 'Spinal',
			'sell' => "(".$spinal_total_std."±".$spinal_total_avg.")"
		);
		$time_spent[] = array(
			'day'   => 'CSE',
			'sell' => "(".$cse_total_std."±".$cse_total_avg.")"
		);
		...
		return view('cnb/labourReports/labour_Recovery_v', $data);    
     ...
     public function labour_Analgesia() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_Analgesia_v', $data);              
	 ...
	 public function labour_Co_Morbid() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_morbid_v', $data);              
    ...
    public function labour_Anasthetic() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			return view('cnb/labourReports/labour_anasthetic_v', $data);    
     ...
     public function labour_Supervision() {  
...
// print_r($total2);die();
		...
		return view('cnb/labourReports/labour_supervision_v', $data);       
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }   
    public function labour_Sedation() {  
       $db = \Config\Database::connect();
       ...
       $from_date = session()->get('from_date');
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			return view('cnb/labourReports/labour_Sedation_v', $data);       
   ...
   public function labour_PatientPositon() {  
       $db = \Config\Database::connect();
       ...
       $from_date = session()->get('from_date');
	    ...
	    $total = session()->get('n');
			...
			return view('cnb/labourReports/labour_Patientpositon_v', $data);            
    ...
    public function labour_vertibral_intraspace() {  
       $db = \Config\Database::connect();
...
// epidural_name
		...
		return view('cnb/labourReports/labour_Vertebral_v', $data);       
    ...
    public function labour_Approach() {  
       $db = \Config\Database::connect();
       ...
       $from_date = session()->get('from_date');
		...
		$data['total'] = $total; 
		$data['total_n'] = $total;       
			return view('cnb/labourReports/labour_approach_v', $data);      
       ...
       public function labour_no_attempts() {  
       $db = \Config\Database::connect();
		...
		$data['total_n'] = $avg_cse + $avg_csa + $avg_spinal + $avg_csa;    
			return view('cnb/labourReports/labour_noattempts_v', $data);      
     ...
     public function labour_Technique() {  
       $db = \Config\Database::connect();
       $from_date = session()->get('from_date');
		$to_date = session()->get('to_date');
        $dr_id = session()->get('dr_id');
...
// cath mark
		...
		$data['total'] = $total;
			...
			return view('cnb/labourReports/labour_technique', $data);       
        ...
        public function labour_Epidural_LA() {  
	...
	$builder = $db->table('cnb_postop');
      ...
      return view('cnb/labourReports/labour_epiduralLA_v', $data);             
    }else{
		return redirect()->route("labour-n-report");
	}
...
$builder = $db->table('cnb_postop');
      ...
      return view('cnb/labourReports/labour_csaLA_v', $data);             
    }else{
		return redirect()->route("labour-n-report");
	}
 
}// Epidural Component Single Dose
    public function labour_epidural_singledose() {  
        $db = \Config\Database::connect();
...
// Dexamethasone with Dose(mg)
		...
		return view('cnb/labourReports/labour_epidural_singledose_v', $data);    
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
public function labour_median_sensory() {  
        $db = \Config\Database::connect();
...
// onset of surgical_anaesthesia
        ...
        return view('cnb/labourReports/labour_median_sensory_v', $data);      
		...
		return redirect()->route("labour-n-report");
          ...
          public function labour_motor_block() {  
        $db = \Config\Database::connect();
        ...
        return view('cnb/labourReports/labour_motor_block_v', $data);             
...
// Rahul
       	 public function labour_epidural_needle() {  
    	...
    	$n_type = gettype($n);
			...
			return view('cnb/labourReports/labour_epidural_needle_v', $data);              
		}else{
		return redirect()->route("labour-n-report");
	}	
		
    }
    public function labour_spinal_needle() {  
	 ...
	 public function labour_csa_needle() {  
		...
		return view('cnb/labourReports/labour_csa_needle_v', $data);         
    ...
    public function labour_epidural_adjuvant() {
	...
	// print_r($data);die();
		...
		return view('cnb/labourReports/labour_epidural_adjuvant_v', $data);           
	...
	public function labour_component_adjuvant() {
		...
		if($record){
			...
			$data['products'] = $products;
			$data['total'] = $total;
		return view('cnb/labourReports/labour_component_adjuvant_v', $data);   
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
	public function labour_spinal_adjuvant() {
		...
		return view('cnb/labourReports/labour_spinal_adjuvant_v', $data);         
	...
	public function labour_csa_adjuvant() {
		...
		return view('cnb/labourReports/labour_csa_adjuvant_v', $data);   
	...
	public function labour_epidural_component_adjuvant() {
		...
		return view('cnb/labourReports/labour_epidural_component_adjuvant_v', $data);   
	...
	public function labour_spinal_component_adjuvant() {
		...
		return view('cnb/labourReports/labour_spinal_component_adjuvant_v', $data);      
   ...
   public function labour_safety() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
	        ...
	        $data['total'] = $total; 
			return view('cnb/labourReports/labour_safety_v', $data);     
     ...
     public function labour_surgery() {  
		...
		if($from_date && $to_date  && $n_type != 'NULL'){
			...
			$data['total'] = $total;   
			return view('cnb/labourReports/labour_surgery', $data);
		...
		public function labour_Epidural_Component_Single_Dose() {  
		...
		return view('cnb/labourReports/labour_epidural_component_single_dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
		public function labour_Epidural_Component_Sala_Dose() {  
		...
		return view('cnb/labourReports/labour_epidural_component_sala_dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
		public function labour_Spinal_Component_Single_Dose() {  
		...
		return view('cnb/labourReports/labour_Spinal_Component_Single_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
	public function labour_Spinal_Component_Combo_Dose() {  
		...
		return view('cnb/labourReports/labour_Spinal_Component_Combo_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
	public function labour_Epidural_Single_Dose() {  
		...
		return view('cnb/labourReports/labour_Epidural_Single_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
		public function labour_Epidural_Sala_Combo_Dose() {  
		...
		return view('cnb/labourReports/labour_Epidural_Sala_Combo_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
	public function labour_Spinal_Dose() {  
		...
		return view('cnb/labourReports/labour_Spinal_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
		public function labour_Spinal_Combo_Dose() {  
		...
		return view('cnb/labourReports/labour_Spinal_Combo_Dose', $data);      
		
	}else{
		return redirect()->route("labour-n-report");
	}
    }
		public function labour_csa_Component_single_Dose() {  
		...
		return view('cnb/labourReports/labour_csa_Component_single_Dose', $data);      
