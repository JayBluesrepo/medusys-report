...
class Dashboard extends BaseController
{
    ...
    public function index()
    {
        ...
        if($dr_id){
            ...
            $model3 = new PostopModel();
            $model4 = new FollowupModel();
            $model5 = new combinedSpinalEpiduralModel();
            $model6 = new EpiduralModel();
            $model7 = new SpinalModel();
            $model8 = new CSA_Model();
            ...
            $patient_Model->select('id, rad_id, patient_name');
            ...
            return view('cnb/dashboard',$data);
        }else{
            return view('login');
        }
    }
