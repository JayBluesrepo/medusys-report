<?php
namespace App\Controllers\conference_new ;
...
use App\Models\conference_EventModel;
...
class Conference extends BaseController
{
    ...
    $dr_id = session()->get('dr_id');
        ...
        if($dr_id){
            ...
            $data['dr_id'] =  $dr_id;
            return view('conference_new/conference_home',$data);
        }
        else{
            return view('login');
        }
    ...
    public function conference_about()
    {
            ...
            $model1 = new Conf_About();
            $model1->select('*');
            $data['val']  = $model1->where('keyword',$conference_id)->first();

            $conference_id_num  = $data['val']['conference_id'];

            $model2 = new conference_EventModel();
            $model2->select('*');
            $model2->where('conference_id',$conference_id_num);
            $events  = $model2->get()->getResultArray();
            $data['events'] = $events;
            return view('conference_new/conference_about',$data);
    ...
    public function programs()
    {
            ...
            $data['dr_id'] =  $dr_id; 
            return view('conference_new/program_schedule',$data);
    }
    public function faculty_details()
    {
	    ...
	    $model3 = new ProgramScheduleModel(); 
            ...
            $data['dr_id'] =  $dr_id; 
            return view('conference_new/faculty_details',$data);
        }
        else{
            return view('login');
        }
    ...
    public function registration_details()
    {
        ...
        if($dr_id){
            ...
            return view('conference_new/conference_registation',$data);
        }
        else{
            return view('login');
        }
        ...
        if($dr_id){
            ...
            if($data['val']['reg_fee'] != 0){
                ...
                if($payment){
                    ...
                    return view('conference_new/attend_conference',$data);
                }
                else{
                    return view('conference_new/no_payment',$data);
                }
            }
            else{
                ...
                if($data['val']['reg_fee'] != 0){
                    ...
                    if($payment){
                        ...
                        if(strtotime($data['val']['date_to']) > strtotime($today)){ 
                            return view('conference_new/no_time',$data); 
                        }
                        else{
                            return view('conference_new/feedback',$data);
                        } 
                    }
                    else{
                        return view('conference_new/no_payment',$data);
        ...
        if($dr_id){
            ...
            if($data['val']){ 
                ...
                if($feedback){
                        ...
                        $html = view('conference_new/certificate_v_new',$data);  
...
."."<br/><br/>"; 
                        ...
                        return view('conference_new/certificate_v',$data);
                    
                }
                else{
                    
                    return view('conference_new/no_feedback',$data);
                }
