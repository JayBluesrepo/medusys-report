...
{   
    ...
    {   
        ...
        if($dr_id){       
            ...
            if(!empty($detail)){
                ...
                return view('labour/combined_spinal_epidural',$data);
            }  
        }else{
            return view('login');
        }
    ...
    public function add_combined_procedure(){
        ...
        $combined_details = array(
            ...
            'tc_failure_spinal_component' => $tc_failure_spinal_component,
        ...
        $adding_combined_details = new labour_combinedSpinalEpiduralModel();
