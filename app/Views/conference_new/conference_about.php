...
//print_r($val);
//die();
    echo view('includes/flow_header_new');    
?>
                ...
                <header class="cf pt-4">
                    <div class="navigation"> 
                        <nav>
                            ...
                            <nav> 
                            <ul class="mobimenu">
                                <li class="conf-act"><a href="<?php echo base_url('/Conference-Detailsc?id='.$val['conference_id']); ?>">About</a></li>
                                <li><a href="<?php echo base_url('/Programsc?id='.$val['conference_id']); ?>">Program Schedule</a></li>
                                <li><a href="<?php echo base_url('/Faculty-Detailsc?id='.$val['conference_id']); ?>">Faculty</a></li>
                                <li ><a href="<?php echo base_url('/Registration-Detailsc?id='.$val['conference_id']); ?>">Registration</a></li>
                            </ul>
                        </nav>
                        </nav>
                    </div>
