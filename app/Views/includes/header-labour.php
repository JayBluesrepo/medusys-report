...
<body>
    ...
    <section class="header">
        <div class="row">
            ...
            <div class="col-sm-4">
               <h4 style="float:right;margin: 28px -32px 0 0; color:#0b5077;font-weight: 600;font-size: 25px;" id="new-head">Labour Analgesia</h4>
            </div>
            <div class="col-sm-5">
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="home-right">
                        ...
                        // die(); 
                        if(($pat) && ($pcheck)){ ?>
                                <li role="presentation" class="active"><a href="<?php echo base_url('labour/patientDetails'); ?>" aria-controls="home">Patient Details<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($pat)){  
                            ?>
                                <li role="presentation" class="active"><a href="<?php echo base_url('labour/patientDetails'); ?>" aria-controls="home">Patient Details</a></li>
                            <?php
                                }else{
                            ?>
                                <li role="presentation" ><a href="<?php echo base_url('labour/patientDetails'); ?>" aria-controls="home">Patient Details<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                            <?php if(($eco) && ($ecocheck)){ ?>
                                <li role="presentation" class="active"><a href="<?php echo base_url('labour/E_consent'); ?>" aria-controls="consent" role="tab" >E-Consent<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($eco)){  
                            ?>
                                <li role="presentation" class="active"><a href="<?php echo base_url('labour/E_consent'); ?>" aria-controls="consent" role="tab" >E-Consent</a></li>
                            <?php
                                }else{
                            ?>
                                <li role="presentation" ><a href="<?php echo base_url('labour/E_consent'); ?>" aria-controls="consent" >E-Consent<i class="fa fa-check-circle-o" aria-hidden="true" id="ecocheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                            <?php if(($pre) && ($precheck)){ ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Preop'); ?>" aria-controls="profile" role="tab" >Pre-procedure<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($pre)){  
                            ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Preop'); ?>" aria-controls="profile" role="tab" >Pre-procedure</a></li>
                            <?php
                                }else{
                            ?>
                                <li role="presentation"><a class="test1" href="<?php echo base_url('labour/Preop'); ?>" aria-controls="profile">Pre-procedure<i class="fa fa-check-circle-o" aria-hidden="true" id="precheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                            <?php if(($procs) && ($proccheck)){ ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Proc'); ?>" aria-controls="messages" role="tab" >Procedure<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($procs)){  
                            ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Proc'); ?>" aria-controls="messages" role="tab" >Procedure</a></li>
                            <?php
                                }else{ 
                            ?>
                                <li role="presentation"><a class="test1" href="<?php echo base_url('labour/Proc'); ?>" aria-controls="messages" role="tab" >Procedure<i class="fa fa-check-circle-o" aria-hidden="true" id="proccheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                            <?php if(($post) && ($postcheck)){ ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Pacu'); ?>" aria-controls="settings" role="tab" >Post-procedure<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($post)){  
                            ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Pacu'); ?>" aria-controls="settings" role="tab" >Post-procedure</a></li>
                            <?php
                                } else{
                            ?>
                                <li role="presentation"><a class="test1" href="<?php echo base_url('labour/Pacu'); ?>" aria-controls="settings">Post-procedure<i class="fa fa-check-circle-o" aria-hidden="true" id="postcheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>    
                            <?php if(($foll) && ($follcheck)){ ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/followUp'); ?>" aria-controls="about" role="tab" >Follow Up<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($foll)){  
                            ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/followUp'); ?>" aria-controls="about" role="tab" >Follow Up</a></li>
                            <?php
                                } else{
                            ?>
                                <li role="presentation"><a class="test1" href="<?php echo base_url('labour/followUp'); ?>" aria-controls="about">Follow Up<i class="fa fa-check-circle-o" aria-hidden="true" id="follcheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                            <?php if(($feed) && ($feedcheck)){ ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Feedback'); ?>" aria-controls="contact" role="tab" >Feedback<i class="fa fa-check-circle-o" aria-hidden="true" style="color:green;margin-left:5px;"></i></a></li>
                            <?php 
                                }elseif(($feed)){  
                            ?>
                                <li role="presentation" class="active"><a class="test1" href="<?php echo base_url('labour/Feedback'); ?>" aria-controls="contact" role="tab" >Feedback</a></li>
                            <?php
                                } else{
                            ?>
                                <li role="presentation"><a class="test1" href="<?php echo base_url('labour/Feedback'); ?>" aria-controls="contact" >Feedback<i class="fa fa-check-circle-o" aria-hidden="true" id="feedcheck" style="color:green;margin-left:5px;"></i></a></li>
                            <?php
                                } 
                            ?>
                        </ul>
...
<script>
    ...
    $('#password_see').click(function(){
        ...
        $.ajax({
            type: 'POST',
            url : '<?php echo base_url('see-password-labour') ?>',
...
<script>
    ...
    function upload_patient1(){
        ...
        if(z == true){
            ...
            $.ajax({
                type : 'POST',
                url  : '<?php echo base_url("upload-patient-record-search")?>',
                data : {z:z},
                success:function(response){
                    response=jQuery.parseJSON(response);
                    var mode1='';
...
<script>
    function myfun(key){
        ...
        // alert(id);
        // $('#a').val(id);
        window.location = '<?php echo base_url("Patients-labour")?>?id='+id;
    }
    function resetfun(){
        $('#add_patient')[0].reset();
        $('#myModal').modal('hide');
...
<script>
    ...
    function fun(){
        ...
        if(check){
            $.ajax({ 
                type : "POST",
                url : '<?php echo base_url("searchingPatientsDetails") ?>',
