    ...
    <form id="add_csa">
        <div class="add-patient" id="">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <small class="cnbdone pt-2" style="color:red; display:none;">select the option</small>
                </div>
            </div><!--row-->
            <div class="row pt-4">
	    ...
	    <label class="pt-2">Patient status during Neuraxial Block<span class="mandat">*</span></label>&nbsp
            ...
            <div class="col-sm-10">
                ...
                <div class="acute">
                    ...
                    <div class="form-check" style="display: flex;">
                        ...
                        <input type="text" class="form-control"  name="ac_other_input" id="ot1" style="width: 30%; display:none;" >
                    </div>
                    <!-- <div class="form-check" style="display:none;">
                        <label class="form-check-label">
    ...
    $('#add_csa').submit(function(e){
        ...
        if((aa) && (bb) && (cc) && (dd) && (ee) && (ii) && (jj)){
            ...
            if(i == 1){
                ...
                $.ajax({
                    type : 'POST',
                    url : '<?php  echo base_url("csa-procedure-obstetrics")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
                    success:function(response){
                        ...
                        if(response.result==1){
                            ...
                            $('#add_csa')[0].reset();   
                            window.location = '<?php echo base_url("obstetrics/CSA_add_view")?>?id='+response.msg;     
                        }
                        else{
