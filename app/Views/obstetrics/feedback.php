                    ...
                    <table class="table table-bordered" style="margin-top:20px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url("obstetrics/ManualFeedback/show_manual")?>" target="_blank" style="background-color:transparent!important;color:blue!important;text-align: center;display: block;"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a><!--<i class="fa-solid fa-file-pdf"></i>-->
                                </td>
                            </tr>
                        </tbody>
					</table>
            <?php } else{ ?>
                <li id="man"><a href="<?php echo base_url('obstetrics/ManualFeedback'); ?>">Add Feedback Manually</a></li>
            <?php }?>
            <?php if($rsend){ ?>
                    ...
                    <table class="table table-bordered" style="margin-top:20px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url("obstetrics/E_Feedback/show_feedback")?>" target="_blank" style="background-color:transparent!important;color:blue!important;text-align: center;display: block;"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a><!--<i class="fa-solid fa-file-pdf"></i>-->
                                </td>
                            </tr>
                        </tbody>
					</table>
...
<script type="text/javascript">
    $('#mail').click(function(){
        $.ajax({
            url : '<?php  echo base_url("obstetrics/E_Feedback")?>',
    ...
    $('#mail1').click(function(){
        $.ajax({
            type : "POST",
            url : '<?php  echo base_url("Resend-obstetrics")?>',
            success:function(response){
                response = jQuery.parseJSON(response);
                if(response.result==1){
