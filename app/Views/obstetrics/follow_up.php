<?php
    echo view('includes/header-obstetric',$patient, $foll, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
...
<div role="tabpanel" class="tab-pane" id="about">
    <section class="add-follow-up">
        ...
        <form id="add-followup">
            ...
            <h5><b>Select Follow up Procedure</b></h5>
            <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-4">
                    <div class="form-check">
...
$(document).ready(function(){
    $('#add-followup').submit(function(e){
        ...
        $.ajax({
            type : "POST",
            url : '<?php  echo base_url("addFollow-obstetrics")?>',
            data : formData,
            contentType: false,
            processData: false,
            success:function(response){
                ...
                if(response.result==1){
                    ...
                    window.location = '<?php echo base_url("obstetrics/FollowupDetails")?>?id='+response.msg;     
                }
                else
