<?php
    echo view('includes/header-obstetric',$patient, $post, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
<!-----------------------------------PACU START----------------------------------->
<div role="tabpanel" class="tab-pane" id="settings">
    <section class="add-pacu">
        ...
        <h5><b>Pain Score (0-10) (0:Min,10:Max)</b></h5>
            ...
            <h5 class="pt-2"><b>Analgesia Supplement in Recovery</b>
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="intra">
                            <div class="row" style="padding-top:15px;">
                                <div class="col-sm-12" id="id">
                                    <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <input type="text" class="form-control remove_supplement remove_supplement1" name="intra_name[]">&nbsp;&nbsp;
                                    <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <input type="number" class="form-control remove_supplement remove_supplement1" name="intra_dose[]">&nbsp;&nbsp;
                        ...
                        <div class="nsa">
                            <div class="row" style="padding-top:15px;">
                                <div class="col-sm-12" id="id">
                                    <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <input type="text" class="form-control remove_supplement remove_supplement4" name="nsa_name[]">&nbsp;&nbsp;
                                    <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <input type="number" class="form-control remove_supplement remove_supplement4" name="nsa_dose[]">&nbsp;&nbsp;
                        ...
                        <!-- <div class="form-check" id="id">
                            <label class="form-check-label">
                                <input type="hidden" class="form-check-input" value="No" name="">
                                <input type="checkbox" class="form-check-input" id="reg" value="Yes" name="">Peripheral Nerve Blocks
                            </label>
                        </div> -->
                        <div class="form-check" id="id">
                            <label class="form-check-label">
            ...
            <div class="row pt-2">
              ...
              <h6 class="pt-3"><b>Foetal Outcome</b></h6>
                <div class="row">
                    <div class="col-sm-2"></div>
        ...
        <!-------------------------------------------->
            <div class="row pt-5">
                ...
                <div class="col-sm-4 pt-3">
                    <input type="number" class="form-control" name="duration_stay">
                </div>
                <div class="col-sm-6"></div>
            </div>
            <div class="row">
...
$(document).ready(function(){
    $('#add-pacu').submit(function(e){
        ...
        $.ajax({
            type : "POST",
            url : '<?php  echo base_url("add-postop-obstetrics")?>',
            data : formData,
            contentType: false,
            processData: false,
            success:function(response){
                ...
                if(response.result==1){
                    ...
                    $('#add-pacu')[0].reset();  
                    window.location = '<?php echo base_url("obstetrics/PacuDetails")?>?id='+response.msg;      
                }
                else
