<?php
    echo view('includes/header-obstetric',$patient, $pat, $pcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check);    
?>
                    ...
                    <div class="modal-body">
                        <form id="edit_patient">
                           ...
                           <!--  <div class="row">
                            ...
                            <!-- <div class="row">
                                <div class="col-sm-2">
                                   <label>CNB done by<span class="mandat">*</span>
...
<script>
    ...
    $('.history').click(function(){
        ...
        $.ajax({
            type : "POST",
            url : "<?php echo base_url("History-obstetrics")?>",
            // data : {id:id},
    ...
    $(document).ready(function(){
        $('.edit').click(function(){
            ...
            $.ajax({
                type : "POST",
                url : "<?php echo base_url("edit-patient-fetch-obstetrics")?>",
                data : {id:id},
                success:function(response) {
                    response = jQuery.parseJSON(response);
                    if(response.result == 1){
        ...
        $('#del').click(function(){
            ...
            swal({   
                title: "Are you sure?",
                text: "Patient record will be deleted from Obstetrics",
            ...
            function(isConfirm){   
                if(isConfirm){ 
                    ...
                    $.ajax({
                        type : "POST",
                        url : '<?php  echo base_url("delete-patient-obstetrics")?>',
                        ...
                        success:function(response){
                            ...
                            if(response.result==1){
                                ...
                                window.setTimeout(function() {
                                    window.location = '<?php echo base_url("obstetrics/Dashboard")?>';
                                }, 2000);
                            }
                            else
        ...
        $('#edit_patient').submit(function(e){
            ...
            if(age1 && weight1){
                ...
                $.ajax({
                    type : 'POST',
                    url : '<?php echo base_url("edit-patient-details-obstetrics") ?>',
                    data : formData,
                    contentType: false,
                    processData: false,
