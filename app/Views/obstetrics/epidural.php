        ...
        <div class="col-sm-4" style="margin-top:50px;">
            <div class="form-check-inline">
              <label class="form-check-label">
                <input type="radio" class="form-check-input" value="Yes" id="epidural_in_situ_yes" onclick="epidural_in_situ_show('Yes')" name="epidural_in_situ" checked>Yes
              </label>
            </div>
            <div class="form-check-inline">
              <label class="form-check-label">
    ...
    <small class="psn" style="color:red; display:none;">please choose patient status</small>
        ...
        <div class="row pt">
            ...
            <div class="col-sm-4">
                ...
                <select class="form-control" name="no_attempts" id="no_attempts">
                    <option value="">Select</option>
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                ...
                <div class="technical">
                    <div class="tech-compli">
                        ...
                        <ul style="margin-bottom:0px;padding-left: 0;">
                            ...
                            <li>
                                <input onkeydown="return /[a-z]/i.test(event.key)" class="form-control" id="othe1" name="other4" style="display:none;">
                            </li>
                        </ul>
            ...
            <div class="col-sm-10">
                ...
                <div class="acute">
                    ...
                    <div class="form-check" style="display: flex;">
                        ...
                        <input onkeydown="return /[a-z]/i.test(event.key)" class="form-control" name="other5" id="ot1" style="width: 30%; display:none;">
                    </div>
                   <!--  <div class="form-check">
                        <label class="form-check-label">
        ...
        if(epidural_in == false){
            ...
            if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
                ...
                if(i == 1){
                    ...
                    $.ajax({
                        type : "POST",
                        url : '<?php  echo base_url("addEpi-obstetrics")?>',
                        data : formData,
                        contentType: false,
                        processData: false,
                        success:function(response){
                            ...
                            if(response.result==1){
                                ...
                                $('#add-epi')[0].reset();   
                                window.location = '<?php echo base_url("obstetrics/EpiDetails")?>?id='+response.msg;     
                            }
                            else
