<?php
    echo view('includes/header-obstetric',$patient, $foll, $follcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
                ...
                <div class="modal-body">
                    <form id="edit-followup">
                        ...
                        <ul class="late" style="padding-left: 0;padding-top: 20px;">
                            <li class="pr-2"><label><b>Late Complications</b>
...
$('#edit-followup').submit(function(e){
    ...
    $.ajax({
        type : "POST",
        url : '<?php  echo base_url("editFollowup-obstetrics")?>',
        data : formData,
        contentType: false,
        processData: false,
