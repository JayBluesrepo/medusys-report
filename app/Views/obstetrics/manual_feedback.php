<?php
    echo view('includes/header-obstetric',$patient, $feed, $feedcheck, $preo, $posto, $follo, $proccheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
<section>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#save-feedback').submit(function(e){
            ...
            $.ajax({
                type : "POST",
                url : '<?php  echo base_url("addFeed-obstetrics")?>',
                data : formData,
                contentType: false,
                processData: false,
                success:function(response){
                    ...
                    if(response.result==1){
                        ...
                        window.location = '<?php echo base_url("obstetrics/Feedback")?>?id='+response.msg;       
                    }
                    else
