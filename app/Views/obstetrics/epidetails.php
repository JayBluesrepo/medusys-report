            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td class="bg-pat2">Epidural In-Situ (Pre-existing epidural)</td>
                            <td><?php echo $info['epidural_in_situ']; ?></td>
                        </tr>
                        <?php if($info['epidural_in_situ'] == 'No'){ ?>
                ...
                <div class="modal-body">
                    <form id="edit-epi">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">                                       
                                    <div class="input-group date" id="datePicker5">
                                        <input type="text" class="form-control date_time_m" style="border-radius: 15px;" id='datetimepicker1' name="date_m">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control cnb_done_by1 done_by1" id="cnb_done_by1" name="cnb_done_by1" onchange="selectcnb()">
                                ...
                                <select class="form-control cnb_done_by2 done_by2" id="cnb_done_by2"  style="margin: 15px 0;"  name="cnb_done_by2">
                                    <option value="" selected="selected">Select</option>                            
                        ...
                        <div class="row mt-4 mb-4">
                            <div class="col-sm-4"><label>Epidural In-Situ (Pre-existing epidural)<span class="mandat">*</span></label></div>
                            <div class="col-sm-4" style="margin-top:50px;">
                                <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="Yes" id="epidural_in_situ_yes" onclick="epidural_in_situ_show('Yes')" name="epidural_in_situ" >Yes
                                </label>
                                </div>
                                <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="No" id="epidural_in_situ_no" onclick="epidural_in_situ_show('No')" name="epidural_in_situ" >No
                                </label>
                                </div>
                            </div>
                            <div class="col-sm-4"></div>
                        </div>  
                        <div class="epidural_in_situ" style="display:none;">
                                       ...
                                       <i class="fa fa-info-circle" aria-hidden="true"></i>
                                        <div class="right-21">
                                            <div class="text-content-21">
                                               <h6><b>Partial Success</b>:<br>pain scoresVNRS 25-75% reduction, requires further top-up, alternative analgesia to improve quality of analgesia. Moderate patient satisfaction scores</h6>
                                                <i></i>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function epidural_in_situ_show(key){
      
        if(key == 'Yes'){
            $('.epidural_in_situ').hide();
        }else{
            $('.epidural_in_situ').show();
        }
    }

    // var epidural_in_situ = $('#epidural_in_situ_yes').val();
    var epidural_in_situ = "<?php echo $info['epidural_in_situ']; ?>";
    // alert(epidural_in_situ);
    if(epidural_in_situ == 'Yes'){
        $('.epidural_in_situ').hide();
        $('#epidural_in_situ_yes').attr("checked",true);
    }else{
        $('.epidural_in_situ').show();
        $('#epidural_in_situ_no').attr("checked",true);
    }
...
<script>
    ...
    var cnb2 = "<?php echo $info['cnb2']; ?>";
    var supervision = "<?php echo $info['supervision']; ?>";
    var date1 = procedure_date.replace('-', '/');      
    // alert(cnb1);
...
// alert(aa12[0]);
if(aa12[0] == 'Other'){
    $('#skin_prep').val(aa12[0]);  
    $('#skin_prep_other').val(aa12[1]);    
...
$('#edit-epi').submit(function(e){
    ...
    var epidural_in = $('#epidural_in_situ_yes').is(':checked');
    ...
    if(epidural_in == false){
        ...
        if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
            ...
            if(i == 1){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("editEpidu-obstetrics")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
