...
<section class="e-feedback-mail">
	<form id="save-efeedback">
		<h3>E-Feedback</h3>
		 <div class="feed-card">
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check1" name="option1" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check5" name="option2" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check9" name="option3" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check13" name="option4" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check17" name="option5" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check21" name="option6" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check25" name="option7" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check29" name="option8" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check33" name="option9" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
                ...
                <ul>
                    ...
                    <li>
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" id="check37" name="option10" value="No" checked>No
                            </label>
                        </div><!--form-check-->
                    </li>
                    <li>
        ...
        <div class="feed-card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 py-2">
                            <div class="form-check-inline">
                                ...
                                <input type="radio" class="form-check-input" name="option11" onclick="option_show('Yes')" value="Yes">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="option11" onclick="option_show('No')" value="No">No
                                </label>
                            </div>
                        </div>
                    </div><!--row-->
                    <div class="row py-2" id="pain_before_surgery_a" style="display:none;">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-8">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="option12" onclick="sub_option_show('Yes')" value="Yes">Yes
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="option12" onclick="sub_option_show('No')" value="No">No
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-2"></div>
                    </div><!--row-->
                    <div class="row py-2" id="managed_b" style="display:none;">
                        <div class="col-sm-6">
                ...
                <div class="card-info1">
                    <h6>5).How satisfied have you been with pain therapy after surgery ?</h6>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                ...
                <div class="card-info1">
                    ...
                    <div class="form-check-inline">
                        <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="option19" value="Moderate:definetly noticeable">Moderate:definitely noticeable
                        </label>
                    </div>
                    <div class="form-check-inline">
                        <label class="form-check-label">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3" id="submits1"><button type="submit"  class="btn-submit">Submit</button></div>
                </div>
            </div>
        </div><!--feed-card-->
	</form>
...
<script type="text/javascript">
    ...
    function option_show(key){    

        if(key == 'Yes'){
            $('#pain_before_surgery_a').show();
            $('#managed_b').hide();
        }else{
            $('#pain_before_surgery_a').hide();
            $('#managed_b').hide();
        }
    }

    function sub_option_show(key){
        if(key == 'Yes'){
            $('#managed_b').show();
        }else{
            $('#managed_b').hide();
    ...
    $(document).ready(function(){
        var track_id = "<?php echo $track[0]; ?>";
        $('#save-efeedback').submit(function(e){
            e.preventDefault();
            var formData = new FormData(this);
            $.ajax({
                type : "POST",
                url : '<?php  echo base_url("add-efeed-obstetrics")?>?track_id='+track_id,
                data : formData,
                contentType: false,
                processData: false,
...
<script>
var tracks = "<?php echo $test['track']; ?>";
var trac = "<?php echo $track[0]; ?>";
if(tracks != trac){
    $('#save-efeedback').hide();
    toastr.error('Patient already exists.....');
}
</script>
...
<style type="text/css">
    ...
    .card-header h4{font-weight: 600;color: #000;}
    .feed-card ul{
    ...
    .card-info1 .form-check-inline{
        margin: 15px 0 10px 20px;
    }
    .pt{
        padding-top: 10px;
    }
    .card-info1 .form-control{
        border-radius:15px;
        margin: 15px;
    }
    .btn-submit{
