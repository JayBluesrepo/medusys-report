<?php
    echo view('includes/header-obstetric',$patient, $post, $postcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
...
<section class="pacu-details">
    ...
    <h4 class="pt-3"><b>Post-Op Care Unit / Recovery</b></h4>
    ...
    <label class="mt-3"><b>Foetal Outcome</b></label>
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td class="bg-pat2">Acidosis (ph < 7.2)</td>
                        <td><?php echo $info['acidosis']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">Naloxone Required</td>
                    ...
                    <tr>
                        <td class="bg-pat2">Birth Trauma</td>
                    ...
                    <tr>
                        <td class="bg-pat2">Other</td>
                        <td><?php echo $info['foetal_other']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">Duration of stay in hospital (days)</td>
                        <td><?php echo $info['duration_stay']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" id="add-header">
                    <h4 class="modal-title">Edit PACU</h4>
                ...
                <div class="modal-body">
                    <form id="edit-postop">
                        <!-- <div class="row">
                            <div class="col-sm-3"><label><b>Duration of Labour (Hours)</b></label></div>
                            <div class="col-sm-3">
                          ...
                          <div class="row pt-4">
                             <div class="col-sm-3"><label><b>Duration of First Stage (Hours)</b></label></div>
                             <div class="col-sm-3">
                                 <input type="number" class="form-control" name="">
                             </div>
                             <div class="col-sm-6"></div>
                          ...
                          <div class="row pt-4">
                             <div class="col-sm-3"><label><b>Duration of Second Stage (Hours)</b></label></div>
                             <div class="col-sm-3">
                                 <input type="number" class="form-control" name="">
                             </div>
                             <div class="col-sm-6"></div>
                         ...
                         <div class="row pt-4">
                             <div class="col-sm-3"><label><b>Oxytocin Required</b></label></div>
                             <div class="col-sm-3">
                                  <div class= "box_1">
                         ...
                         <!-- <label><b>Labour Outcome</b></label>
                            <div class="row">
                        ...
                        <div class="row" style="padding-top:15px;">
                            <div class="col-sm-4"><h6><b>Time Spent in Recovery (mins)</b></h6></div>
                            <div class="col-sm-4">
                                <input type="number" class="form-control" name="time_spent" value="<?php echo $info['time_spent']; ?>">
                            </div>
                            <div class="col-sm-4"></div>
                        </div><!--row-->
                        <h5 class="pt-4"><b>Analgesia Supplement in Recovery</b>
                        ...
                        <label><b>Foetal Outcome</b></label>
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-3 pb-3">
                                <div class="form-check">              
                                    <label class="form-check-label">
                                        ...
                                        <input type="checkbox" class="form-check-input" id="normal" value="Yes" name="normal">Normal
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Yes" id="acidosis" name="acidosis">Acidosis (ph < 7.2)
                                </label>
                                </div> 
                            </div>
                            <div class="col-sm-7 pt-1" id="labour-post-pro">
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Yes" id="naloxone" name="naloxone">Naloxone required
                                </label>
                                </div> 
                            </div>
                            <div class="col-sm-7 pt-1" id="labour-post-pro">
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Yes" id="hypoglecemia" name="hypoglecemia">Hypoglecemia
                                </label>
                                </div> 
                            </div>
                            <div class="col-sm-7 pt-1" id="labour-post-pro">
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Yes" id="birth_trauma" name="birth_trauma">Birth Trauma
                                </label>
                                </div>
                            </div>
                            <div class="col-sm-7 pt-1" id="labour-post-pro">
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-3">
                                ...
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" value="Yes" id="apgar" name="apgar">APGAR at 5 min < 7
                                </label>
                                </div>
                            </div>
                            <div class="col-sm-7 pt-1" id="labour-post-pro">
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="foetal_other" value="Yes" onclick="oth1()" name="foetal_other">Other
                                </label>
                                </div>
                            </div>
                            <div class="col-sm-7 pt-1 foetal_outcome_input" id="labour-post-pro" style="display:none;">
                                <input type="text" class="form-control foetal_other_input" name="foetal_other_input">   
                            </div>
                        </div><!--row-->
                        <!-------------------------------------------->
                        <div class="row pt-5">
                            <div class="col-sm-2"><h6><b>Duration of stay in hospital (days)</b></h6></div>
                            <div class="col-sm-4 pt-3">
                                <input type="number" class="form-control" id="duration_stay" name="duration_stay">
                            </div>
                            <div class="col-sm-6"></div>
                        </div>
                        <div class="row">
...
<script>
    function oth1(){		
		var oth = $('#foetal_other').is(':checked');
		if(!oth){
			$('.foetal_outcome_input').hide();
            $('.foetal_other_input').val('');
		}
		else{
			$(".foetal_outcome_input").show();
		}
	}
</script>
...
var cs1 = "<?php echo $info['normal']; ?>";
if(cs1 == "Yes"){
    $('#normal').attr("checked",true);
}
var cs2 = "<?php echo $info['acidosis']; ?>";
if(cs2 == "Yes"){
    $('#acidosis').attr("checked",true);
}
var cs3 = "<?php echo $info['naloxone']; ?>";
if(cs3 == "Yes"){
    $('#naloxone').attr("checked",true);
}
var cs4 = "<?php echo $info['hypoglecemia']; ?>";
if(cs4 == "Yes"){
    $('#hypoglecemia').attr("checked",true);
}
var cs5 = "<?php echo $info['birth_trauma']; ?>";
if(cs4 == "Yes"){
    $('#birth_trauma').attr("checked",true);
}
var cs6 = "<?php echo $info['apgar']; ?>";
if(cs4 == "Yes"){
    $('#apgar').attr("checked",true);
}
var cs7 = "<?php echo $info['foetal_other']; ?>";
if(cs7 == "Yes"){
    $('#foetal_other').attr("checked",true);
}
var cs8 = "<?php echo $info['other_input']; ?>";
$('.foetal_other_input').val(cs8);

var cs9 = "<?php echo $info['duration_stay']; ?>";
$('#duration_stay').val(cs9);
...
function recov(){
    ...
    if(!reco){
        ...
        if(opi){
            alert('Please remove Intravenous Opioids..');
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(ora){
            alert('Please remove Oral Opiodis ..');
           
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(tra){
            alert('Please remove Tramadol ..');
           
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(nid){
            alert('Please remove NSAID ..');
           
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(temo){
            alert('Please remove Paracetemol  ..');
           
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(reg){
            alert('Please remove LA Regimen  ..');
...
<script type="text/javascript">
    $('#edit-postop').submit(function(e){
        ...
        $.ajax({
            type : "POST",
            url : '<?php  echo base_url("editPostop-obstetrics")?>',
            data : formData,
            contentType: false,
            processData: false,
