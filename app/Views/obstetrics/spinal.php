...
<h3>Add Spinal</h3>
    <form id="add-spine">
        ...
        <div class="ultrasound mb-3" style="display:none;">
            <div class="row pt">
                <div class="col-sm-2"></div>
            ...
            <div class="col-sm-10">
                ...
                <div class="acute">
                    ...
                    <div class="form-check" style="display: flex;">
                        ...
                        <input onkeydown="return /[a-z]/i.test(event.key)" class="form-control" name="other5" id="ot1" style="width: 30%; display:none;" readonly>
                    </div>
                </div><!--acute ends-->
            </div>
        </div><!--row-->
    ...
    $('#add-spine').submit(function(e){
        ...
        if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
            ...
            if(i == 1){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("addSpin-obstetrics")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
                    success:function(response){
                        ...
                        if(response.result==1){
                            ...
                            $('#add-spine')[0].reset(); 
                            window.location = '<?php echo base_url("obstetrics/SpinalDetails")?>?id='+response.msg;
                        }
                        else
