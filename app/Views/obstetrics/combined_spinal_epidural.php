			...
			<form id="combined_spinal_epidural_block">
				<div class="add-patient" id="">
		            ...
		            <div class="row">
		                ...
		                <div class="col-sm-4">
		                    <select class="form-control cnb_done_by1" id="cnb_done_by1" name="cnb_done_by1" onchange="selectcnb()" required>
		                    ...
		                    <select class="form-control cnb_done_by2" id="cnb_done_by2"  style="margin: 15px 0;"  name="cnb_done_by2" required>
		                        <option value="" >Select</option>                            
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="form-check">
							...
							<input type="radio" class="form-check-input" id="Awake" value="Awake" name="neuraxial_block" onclick="hide()">Awake
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label">
							<input type="radio" class="form-check-input" id="Sedation" value="Sedation" name="neuraxial_block" onclick="show()">Sedation
							</label>
						</div>
						...
						<div class="form-check">
							<label class="form-check-label">
								<input type="radio" class="form-check-input" id="GA" value="GA" name="neuraxial_block" onclick="hide()" >GA
							</label>
						</div>
					</div>
					<div class="col-sm-2"></div>
				...
				<div class="row pt">
					...
					<div class="col-sm-4">
						<input type="number" class="form-control" name="epidural_depth">
					</div>
				</div><!--row-->
					...
					<div class="col-sm-10">
						<div class="pt" id="proced-plus" style="border: 1px solid lightgrey;border-radius: 8px;padding: 10px;">
								...
								<div class="opioid spinal_opioid mt-2" style="display:none;" >
									...
									<div class="row pt" style="margin-left:3%;">
										<div class="col-sm-5"><span>Opioid Dose(microgram equivalent)</span></div>
										<div class="col-sm-7"><input type="number" class="form-control" name="spinal_opioid_dose[]"></div>
									</div><!--row-->
								</div>
								<div class="row pt">
									<div class="col-sm-5">
									...
									<div class="col-sm-7"><input type="number" class="form-control spinal_clonidne_input" placeholder="mcgm" name="spinal_clonidne_dose" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
								...
								<div class="col-sm-7"><input type="number" class="form-control spinal_dexmedito_input" name="spinal_dexmedito_dose" placeholder="mcgm" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
								...
								<div class="col-sm-7"><input type="number" class="form-control spinal_dexametha_input" name="spinal_dexametha_dose" placeholder="mg" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
								...
								<div class="col-sm-7"><input type="number" class="form-control spinal_tramadol_input" name="spinal_tramadol_dose" placeholder="mg" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
								...
								<div class="col-sm-7"><input type="number" class="form-control spinal_adrenaline_input" name="spinal_adrenaline_dose" placeholder="mcmg" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
										<label class="form-check-label">
										<input type="checkbox" class="form-check-input spinal_ketamine" value="">Ketamine with Dose(mg)
										</label>
									</div>
								</div>
								<div class="col-sm-7"><input type="number" class="form-control spinal_ketamine_input" name="spinal_ketamine_dose" placeholder="mg" readonly></div>
								</div><!--row-->
								<div class="row pt">
								<div class="col-sm-5">
									<div class="form-check">
										<label class="form-check-label">
										<input type="checkbox" class="form-check-input spinal_midazolam" value="">Midazolam with dose(mg)
										</label>
									</div>
								</div>
								<div class="col-sm-7"><input type="number" class="form-control spinal_midazolam_input" name="spinal_midazolam_dose" placeholder="mg" readonly></div>
								</div><!--row-->
								<div class="row">
								<div class="col-sm-8">
									<div class="form-check">
									...
									<div class="spinal_other_box" style="display:none;">
										...
										<div class="row pt">
											<div class="col-sm-4"><span>Adjuvant Dose(mg)</span></div>
											<div class="col-sm-7"><input type="number" class="form-control" name="spinal_aj_dose[]" ></div>
											<div class="col-sm-1"></div>
										</div>
									</div>
								</div>
						...
						<div class="tech-compli tech_complication_checkbox" style="display:none;">
							...
							<ul style="margin-bottom:0px;padding-left: 0;">	
								<li>
									<div class="form-check">
										<label class="form-check-label">
											<input type="hidden" class="switch_1" value="No" name="failure_spinal_compo">
											<input type="checkbox" class="form-check-input failure_spinal_compo" value="Yes" name="failure_spinal_compo">Failure Of Spinal Component
										</label>
									</div>
								</li>
							</ul>
				...
				<div class="row">
					...
					<div class="col-sm-10">
						...
						<div class="spinal_acute_multi_option_box" style="display:none;">
							...
							<div class="form-check">
								<label class="form-check-label">
									<input type="hidden" class="switch_1" value="No" name="ac_intera_epidural">
									<input type="checkbox" class="form-check-input ac_intera_epidural" value="Yes" name="ac_intera_epidural">Intratheral Migration of Epidural Catheter
								</label>
							</div>
...
//     }
	...
	function technical(){
		...
		var tc_failure_spinal_component =  $('.failure_spinal_compo').is(':checked');
		...
		if(!tech){
			...
			else if(tc_failure_spinal_component){
...
// ---------------------------------------------append function (END)-----------------------------------------------------
	...
	function adjuvant_spinal(){
        ...
        if(!spinal_adjuvant){ 
	        ...
	        var epidural_trama = $('.spinal_tramadol').is(':checked');
	      	...
	      	var epidural_ketamine = $('.spinal_ketamine').is(':checked');
	        var epidural_midazolam = $('.spinal_midazolam').is(':checked');
	...
	$('.spinal_ketamine').click(function(){
		var spinal_clonidne =$('.spinal_ketamine').is(':checked');		
		if(!spinal_clonidne){
        	$(".spinal_ketamine_input").attr("readonly", true);
		}
		else{
			$('.spinal_ketamine_input').removeAttr("readonly");
		}
	});
	$('.spinal_midazolam').click(function(){
		var spinal_clonidne =$('.spinal_midazolam').is(':checked');		
		if(!spinal_clonidne){
        	$(".spinal_midazolam_input").attr("readonly", true);
		}
		else{
			$('.spinal_midazolam_input').removeAttr("readonly");
		}
	});
...
// ------------------------------------------------procedure start-------------------------------------------
	...
	$(document).ready(function(){ 
		$('#combined_spinal_epidural_block').submit(function(e){
			...
			var i = 0;
            if(final1 != ''){
                if(final1.length != 4 || final1 == 'm-,,m-undefined,'){
                    
                    i = 1;
                } 
                if(final2.length != 4 || final2 == 'm-,,m-undefined,'){
            ...
            if(final3 != ''){
                if(final3.length != 4 || final3 == 'm-,,m-undefined,'){
                   
                    i = 1;
                } 
                if(final4.length != 4 || final4 == 'm-,,m-undefined,'){
            ...
            if(final5 != ''){
                if(final5.length != 4 || final5 == 'm-,,m-undefined,'){
                    
                    i = 1;
                } 
                if(final6.length != 4 || final6 == 'm-,,m-undefined,'){
            ...
            if(i == 1){
				...
				if(!document.getElementById('Awake').checked && !document.getElementById('Sedation').checked && !document.getElementById('GA').checked){ 
					$('.psn').show();
				...
				if(ii && ee && jj && bb && aa && cc){
					...
					$.ajax({
						type : "POST",
						url : '<?php  echo base_url("add-combined-procedure-obstetrics")?>',
						data : formData,
						contentType: false,
						processData: false,
						success:function(response){
							...
							if(response.result==1){
								...
								window.location = '<?php echo base_url("obstetrics/combinedSpinalView")?>?id='+response.msg;					
							}
							else{
