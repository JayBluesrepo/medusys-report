                ...
                <div class="modal-body">
                    <form id="edit-spinal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control cnb_done_by1 done1" id="by1" name="cnb_done_by1" onchange="selectcnb()">
                                ...
                                <select class="form-control cnb_done_by2 done2" id="cnb_by2"  style="margin: 15px 0;"  name="cnb_done_by2">
                                    <option value="" >Select</option>                            
                        ...
                        <div class="ultrasound epidural_ultrasound mb-3" style="display:none;">
                            <div class="row pt">
                                <div class="col-sm-2"></div>
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="analgesia" style="display:none;">
                                    <div class="analg-box">
                                        ...
                                        <div class="gesia" style="display:none;">
...
<script>
    ...
    //     var subjectSel = document.getElementById("by1");
    //     var topicSel = document.getElementById("cnb_by2");
...
$(document).ready(function(){
    ...
    if((eee)||(uuu)||(vvv)||(sqq)||(mmm)||(mur)|| qtq == 'Yes' ||(jjj)||(iii)){
...
$('#edit-spinal').submit(function(e){
    ...
    if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
        ...
        var i = 0;
            ...
            $.ajax({
                type : "POST",
                url : '<?php  echo base_url("editSpinal-obstetrics")?>',
                data : formData,
                contentType: false,
                processData: false,
