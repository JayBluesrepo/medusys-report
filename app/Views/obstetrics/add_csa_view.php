                ...
                <table class="table">
                    <tbody>
                        ...
                        <?php
                            ...
                            // print_r($aj_spinal_opioid[0]['name']);
                        ?>
                        <tr>
            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <?php } ?>
                        <tr>
                            <td class="bg-pat2">Paracetamol/Anti-imflammatories</td>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                <form id="csa_modal_update">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="" id = "consultant" style="color:red; display:none;">
                            ...
                            <select class="form-control cnb_done_by2" id="cnb_by2"  style="width:220px;"  name="cnb_done_by2" required>                        
                            </select>
                        </div>
                        </div>
                    </div><!--row-->
                    ...
                    <label class="pt-2">Patient status during Neuraxial Block<span class="mandat">*</span></label>
                    <div class="row">
                ...
                <!-- 	<h5 class="pt"><b>Continous Spinal Anaesthesia(CSA)</b><span class="mandat">*</span></h5> -->
                    ...
                    <!-- </div>row -->
                     ...
                     <h5 style="position: relative;top: 179px;" class="csa-tag pb-4"><b>Click on the appropriate <br> CSA level here</b></h5>
                   ...
                   <h5 class=""><b>Total Intra Operative LA & Adjuvant Consumption</b>
                    ...
                    <div class="row pt">
						...
						<div class= "box_1">
							...
							<input type="checkbox" class="switch_1 epidural_adjuvant" value="Yes" name="ajuvant_status" onclick="epidural_adjuvant()" id = "epidural_adjuvant1">
						</div>
                            ...
                            <div class="spinal_acute_multi_option_box" style="display:none;">
                                ...
                                <!-- <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                        ...
                                        <input type="checkbox" class="form-check-input maternal_fever" id = "maternal_fever" value="Yes" name="maternal_fever">Maternal Fever
                                        <div class="tooltip-5">
                                           <i class="fa fa-info-circle" aria-hidden="true"></i>
                                            <div class="right-5">
                                                <div class="text-content-5">
...
var procedure_date = "<?php echo date("d-m-Y",strtotime($info['procedure_date'])); ?>";
    ...
    var cz = '<?php echo $info['other_aj_name_dose']; ?>';
    var cz12 = jQuery.parseJSON(cz);
    // console.log(cz12[0]['name']);
    ...
    if(aq == 'Yes' || ae == 'Yes' || aw == 'Yes'|| au == 'Yes' || ai == 'Yes' || ap == 'Yes' || gt == 'Yes'){
    ...
    $('#csa_modal_update').submit(function(e){
        ...
        if(i == 1){
			...
			toastr.error('Sensory Levels are incomplete.. Please enter Highest and lowest level...');	
                        // alert('Sensory Levels are incomplete.. Please enter Highest and lowest level...');
        }else{
            ...
            if(aa && bb && zz && ee){
                ...
                $.ajax({
                    type : 'POST',
                    url : '<?php  echo base_url("updateCsa-obstetrics")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
