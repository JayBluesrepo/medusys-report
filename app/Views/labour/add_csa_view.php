...
<section class="add-csa-view">
    ...
    <div class="csa-view-cont">
     ...
     <!--    <h4 class="pt"><b>Test Dose</b></h4> -->
        <div class="csa-view-card2">
            <div class="card-header">
                <h5><b>Labour LA Regimen</b></h5>
            </div>
            <div class="card-body">
                <p><?php echo $info['la_regimen']; ?></p>
            </div>
        </div><!--csa-view-card2-->
        <h4 class="pt"><b>Total Labour LA & Adjuvant Consumption</b></h4>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $info['adrenaline_aj']; ?></td>
                        </tr>
                        <tr>
            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <?php 
                                    $tc_other = explode(',',$info['tc_other']);
                                    if($tc_other[0] == 'Yes'){
                                        ?>
                                        <td class="bg-pat2">Other - Yes</td>
                                        <td><?php echo $tc_other[1]; ?></td>
                                        <?php
                                    } 
                                    else{
                                        ?>
                                        <td class="bg-pat2">Other - No</td>
                                        <td>No</td>
                                        <?php
                                    }
                                   ?>
                ...
                <table class="table">
                    <tbody>
                      ...
                      <!--  </tr>
                        ...
                        <tr>
                            <td class="bg-pat2">Maternal Fever</td>
                            <td><?php echo $info['maternal_fever']; ?></td>
                        </tr>
                         <tr>
                            <td class="bg-pat2">Acute Foetal CTG Changes / Deceleration needing intervention</td>
                            <td><?php echo $info['foetal_CTG']; ?></td>
                        </tr>
                        <tr>
                            <td class="bg-pat2">Other</td>
        ...
        <div class="csa-view-table1">
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        <?php if($info['success'] == 'Partial Success'){ ?>
                        ...
                        <?php }elseif($info['success'] == 'Complete Success'){ ?>
                            <tr>
...
<section class="edit-csa">
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header" id="add-header">
                <h4 class="modal-title">Edit CSA - Continuous Spinal Anaesthesia</h4>
                ...
                <form id="csa_modal_update">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                           ...
                           <div class="" id = "consultant" style="color:red; display:none;" required> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <small class="skp" style="color:red; display:none;">please enter skin prep
                             <input type="text" class="form-control skin_prep_other" name="skin_prep_other"  id = "skin_prep_other" style="margin-top: 12px;">
						...
						<div class="pt epidural_adjuvant_check" id="proced-plus" style="display:none;">
							...
							<div class="form-check">
								<label class="form-check-label">
								    ...
								    <input type="checkbox" class="form-check-input epidural_opioid" value="Yes" name="epidural_opioid_status" onclick="epidural_opioid()" id = "Opioid">Opioid
								</label>
							</div>
                                    ...
                                    ?>      
                                        <div class="row11 mt-2">
                                            <div class="row" style="margin-left:3%;">
                                                ...
                                                <div class="col-sm-7" style="display:flex;"><input type="text" class="form-control epidural_opioid" name="epidural_opioid_name[]" value="<?php echo $val['name']; ?>"><button type="button" class="btn remove22"><i class="fa fa-times" aria-hidden="true"></i></button></div>
                                            </div><!--row-->
                                            <div class="row pt" style="margin-left:3%;">
                                                <div class="col-sm-5"><span>Opioid Dose(microgram equivalent)</span></div>
                                                <div class="col-sm-7"><input type="text" class="form-control epidural_opioid" name="epidural_opioid_dose[]" value="<?php echo $val['dose']; ?>"></div>
                                            </div><!--row-->
                                        </div>
                                    <?php
                                        } 
                            ...
                            <div class="col-sm-7"><input type="text" class="form-control epidural_adrenaline_input" name="epidural_adrenaline_dose" placeholder="mg" readonly></div>
                            </div><!--row-->
								...
								<div class="other1 epidural_other_box"  style="display:none;">
                                    ...
                                    <div class="other9">
                                        <?php 
                                            ...
                                            $aj_epidural_o = 0;
                                            foreach($aj_epidural_other as $key=>$val){
                                                $aj_epidural_o = $aj_epidural_o +1;
                                        ?>      <div class="row2">
                                                    <div class="row pt">
                                                        <div class="col-sm-4"><span>Adjuvant Name</span></div>
                                                        <div class="col-sm-7" id="proced-plus" style="display: flex;"><input type="text" class="form-control" name="epidural_aj_name[]" value="<?php echo $val['name']; ?>"><button type="button" class="btn remove3"><i class="fa fa-times" aria-hidden="true"></i></button></div>
                                                        <div class="col-sm-1"></div>
                                                    </div>
                                                    <div class="row pt">
                                        ...
                                        ?>
                            <input type = "hidden" value = "<?php echo $aj_epidural_o; ?>" id = "aj_epidural_o">
                                    </div><!--other1 ends-->
									...
									<div class="spinal_opioid_supplemen_box  mt-2" style="display:none;" >
                                        ...
                                        <div class="opioids">
                                            <?php                                                
                                                ...
                                                $kk = json_decode($ws, true);                       $Opioids_other = 0;                      
                                                foreach($kk as $key=>$val){
                        $Opioids_other = $Opioids_other +1;
                        ?>
                        <div class="row51">
                            <div class="row" style="margin-left: 3%;">
                                <div class="col-sm-5">
									...
									<input type = "hidden" id = "Opioids_other" value = "<?php echo $Opioids_other; ?>" >	
									</div>
									<div class="form-check" style="margin-left: 3%;">
										<label class="form-check-label">
                            ...
                            <div class="spinal_acute_multi_option_box" style="display:none;">
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        ...
                                        <input type="checkbox" class="form-check-input foetal_CTG"value="Yes" 
                                        name="foetal_CTG">Acute Foetal CTG Changes / Deceleration needing intervention
                                    </label>
                                </div>
                                <div class="form-check" style="display: flex;">
                                    <label class="form-check-label">
                                        <input type="hidden" class="switch_1" value="No" name="ac_other">
                                        <input type="checkbox" class="form-check-input spinal_acute_other" id = "ot" value="Yes" name="ac_other" onclick="other3()">Other
                                    </label>
                                    <input type="text" class="form-control  spinal_acute_other_input ml-3" name="ac_other_input" id="ot1" style="width: 30%;">
                                </div>
                                <!-- <div class="form-check">
                                    <label class="form-check-label">
   ...
   function epidural_adjuvant(){
    ...
    if(!epidural_adjuvant){
        ...
        if(Opioid){
            ...
            toastr.error('Please Uncheck epidural dexme..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true;
        }
            ...
            toastr.error('Please Uncheck epidural trama..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true;
        }
        else if(epidural_ketamine){
            toastr.error('Please Uncheck epidural ketamine..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true;
        }
        else if(epidural_midazolam){
            toastr.error('Please Uncheck epidural midazolam..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true;
        }
        else if(epidural_adrenaline){
            toastr.error('Please Uncheck epidural adrenaline..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true; 
        }

        else if(epidural_other){
            toastr.error('Please Uncheck epidural other..')
            $('#epidural_adjuvant1').attr("checked",true);
            document.getElementById("epidural_adjuvant1").checked = true;
        }
    ...
    var adrenaline_aj = "<?php echo $info['adrenaline_aj']; ?>";
    if(adrenaline_aj){
        $('.epidural_adrenaline').attr("checked",true);
        $('.epidural_adrenaline_input').removeAttr("readonly");
        $('.epidural_adrenaline_input').val(adrenaline_aj);
    }
    
    
    var cz1000 = '<?php echo $info['other_aj_name_dose']; ?>';
    var cz = jQuery.parseJSON(cz1000);
    ...
    var qvc100 = '<?php echo $info['other_aj_name_dose']; ?>';
    var qc101 = jQuery.parseJSON(qvc100);

   
    if((ccc == 'Yes')||(qqq)||(vcs)||(qrq)||(mm)||(mu)||(qvc) || qc101[0]['name'] != ''){
        $('.epidural_adjuvant').attr("checked",true);
        $('.epidural_adjuvant_check').show();
    }
    ...
    if(aq == 'Yes' || ae== 'Yes' || aw== 'Yes' || au== 'Yes' || ai== 'Yes' || ap_split[0]== 'Yes' || gt== 'Yes'){
    ...
    var z21 = '<?php echo $info['maternal_fever'] ?>';
    var z22 = '<?php echo $info['foetal_CTG'] ?>';
    ...
    // }
    if(z21 == 'Yes'){
        $('.maternal_fever').attr('checked',true);         
    }
    if(z22 == 'Yes'){
        $('.foetal_CTG').attr('checked',true);         
    }
    if(z2 == 'Yes'){
    ...
    if(z5 == 'Yes'){
        $('.ac_radicular_pain').attr('checked',true);			
    }
    if(z6 == 'Yes'){
        ...
        if(final5[1] == 'red' || final5[3] == 'green'|| final6[1] == 'red' ||
            ...
            if(i == 1){
                ...
                if(cc && aa && bb && zz && ii && ee){
                    ...
                    $.ajax({
                        type : 'POST',
                        url : '<?php  echo base_url("updateCsa-labour")?>',
                        data : formData,
                        contentType: false,
                        processData: false,
