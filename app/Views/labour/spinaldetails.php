    ...
    <div class="view-spinal-cont">
       ...
       <!--  <h4 class="pt"><b>Spinal Needle Brand,Type and Size</b></h4> -->
        <div class="view-spinal-card2">
            ...
            <div class="card-body">
                <ul><?php if($n_brand){ ?>
                        <li><span><?php echo 'Other-'.$info['other4']; ?></span></li>
                    <?php }else{ ?>
                        <li><span><?php echo $info['needle_brand']; ?></span></li>
                    <?php }; ?>
                    <?php if($n_type){ ?>
                        <li><span><?php echo 'Other-'.$info['other6']; ?></span></li>
                    <?php }else{ ?>
        ...
        <div class="row p-2">
         ...
         <div class="ultrasound mb-3">
            <div class="row pt">
                ...
                <div class="col-sm-4">
                    <select class="form-control" name="probe_cover" id = "probe_cover">
            ...
            <div class="row pt">
                ...
                <div class="col-sm-4">
                    <select class="form-control" name="image_quality" id = "image_quality">
                                    ...
                                    <div class="pt" id="proced-plus" style="">
                                        ...
                                        ?>      <div class="row11">
                                                    <div class="row pt" style="margin-left:3%;">
                                                        ...
                                                        <div class="col-sm-7" style="display:flex;"><input type="text" class="form-control opioid_name" name="opioid_name[]" value="<?php echo $val; ?>"><button type="button" class="btn remove22"><i class="fa fa-times" aria-hidden="true"></i></button></div>
                                                    </div><!--row-->
                                                    <div class="row pt" style="margin-left:3%;">
                                                        <div class="col-sm-5"><span>Opioid Dose(microgram equivalent)</span></div>
                                                        <div class="col-sm-7"><input type="number" class="form-control opioid_name" name="opioid_dose[]" value="<?php echo $t[$key]; ?>"></div>
                                                    </div><!--row-->
                                                </div>
                                            <?php
                                                } 
                                        ...
                                        <div class="gesia">
                                            ...
                                            ?>      <div class="row22">
                                                        <div class="row" style="margin-left: 3%;">
                                                            <div class="col-sm-5"><span>Opioid Name(microgram equivalent)</span></div>
                                   ...
                                   <!--     <input type="text" class="form-control" name="other5" id="ot1" style="width: 30%;" value="<?php echo $info['other2']; ?>" readonly> --->
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            ...
                                            <input type="checkbox" class="form-check-input" value="Yes"  id = "maternal_fever" name="maternal_fever">Maternal Fever
                                            <div class="tooltip-5">
                                               <i class="fa fa-info-circle" aria-hidden="true"></i>
                                                <div class="right-5">
                                                    <div class="text-content-5">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            ...
                                            <input type="checkbox" class="form-check-input" value="Yes" id = "foetal_CTG" name="foetal_CTG">Acute Foetal CTG Changes / Deceleration needing intervention
                                        </label>
                                    </div>
                                    <div class="form-check" style="display: flex;">
                                        <label class="form-check-label">
                       ...
                       <!--  <div class="tooltip-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                    <input type="radio" class="form-check-input" id="com" value="Complete Success" name="optradio2" onclick="complete()">Compelete Success
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                    <input type="radio" class="form-check-input" value="Failure" name="optradio2" id="fail" onclick="failure()">Failure
                                    <div class="tooltip-9">
                                       <i class="fa fa-info-circle" aria-hidden="true"></i>
                                        <div class="right-9">
...
$(document).ready(function(){
    ...
    if( uuu != '' || vvv != '' || sqq != '' || mmm != '' || mur != ''|| qtq == 'Yes' || jjj != ''|| iii != ''){
    ...
    ||(xm == "Yes")||(xn == "Yes")||(xp == "Yes")||(xr == "Yes") || (z21 == "Yes") || (z22 == "Yes")){
...
var xx = "<?php echo $info['anatomical_landmark']; ?>";
    ...
    if(ultrasound == "Yes"){
        $('#ult').attr("checked",true);
        $('.ultrasound').show();
        $('#probe_cover').val(probe);
        $('#image_quality').val(image);
    }
    else{
        $('#ult').attr("checked",false);
        $('.ultrasound').hide();
    }
    ...
    if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
        ...
        if(final5[1] == 'red' || final5[3] == 'green'|| final6[1] == 'red' ||
            ...
            if(i == 1){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("editSpinal-labour")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
