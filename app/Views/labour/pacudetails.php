<?php
    echo view('includes/header-labour',$patient, $post, $postcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
...
<section class="pacu-details">
    ...
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <tr>
                        <td class="bg-pat2">Duration of Labour (Hours)</td>
                        <td><?php echo $info['duration_labour']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">Duration of First Stage (Hours)</td>
                        <td><?php echo $info['duration_first_stage']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">Duration of Second Stage (Hours)</td>
                        <td><?php echo $info['duration_secound_stage']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <tr>
                        <td class="bg-pat2">Oxytocin Required</td>
                        <td><?php echo $info['oxyto']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">Labour Outcome</td>
                        <td><?php echo $info['labour_outcome1']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2"><b>Foetal Outcome</b></td>
                    </tr>

                    <tr>
                        <td class="bg-pat2">Normal</td>
                        <td><?php echo $info['normal']; ?></td>
                    </tr>
                    <tr>
                        <td class="bg-pat2">acidosis</td>
                        <td><?php echo $info['acidosis']; ?></td>
                    </tr>

                    <tr>
                        <td class="bg-pat2">naloxone</td>
                        <td><?php echo $info['naloxone']; ?></td>
                    </tr>

                    <tr>
                        <td class="bg-pat2">hypoglecemia</td>
                        <td><?php echo $info['hypoglecemia']; ?></td>
                    </tr>


                    <tr>
                        <td class="bg-pat2">birth_trauma</td>
                        <td><?php echo $info['birth_trauma']; ?></td>
                    </tr>

                     <tr>
                        <td class="bg-pat2">APGAR at 5 min < 7</td>
                        <td><?php echo $info['apgar']; ?></td>
                    </tr>


                    <?php 
                        $oth = $info['foetal_other'];
                        $oth1 = explode(",",$oth);
                        if($oth == 'No'){
                    ?>
                        <tr>
                    ...
                    <?php
                             $i = 1;
                            for($i = 1; $i< count($oth1); $i++){                   
                    ?>
                        <tr>
                            <td class="bg-pat2"></td>
                            <td><?php echo $oth1[$i]; ?></td>
                        </tr>
                    <?php }} ?>
                    <tr>
                        <td class="bg-pat2">Duration of stay in hospital (days)</td>
                        <td><?php echo $info['duration_stay_hospital']; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
    </div><!--pat-table2-->
    <h4 class="mt-3"><b>Pain Score</b></h4>
    <h6><b>Pain Score(0-10)(0:Min,10:Max)</b></h6>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
    ...
    <h6 class="pt"><b>Nausea & Vomiting Score(0-3)</b></h6>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
    ...
    <h6 class="pt"><b>Sedation Score (1-3)</b></h6>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
    ...
    <!-- <h6 class="pt">Time spent in Post-procedure</h6> -->
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <tr>
                        <td class="bg-pat2">Time spent in Post-procedure</td>
    ...
    <h4 class="mt-4"><b>Post-Procedure Care Unit / Recovery</b></h4>
    <h6 class="pt">Analgesia Supplement in Post-procedure</h6>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <td class=""><?php echo $info['intravenous_opioids']; ?></td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $info['oral_opioids']; ?></td>
                    </tr>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $info['paracetamol']; ?></td>
                    </tr>
                    <?php
            ...
            <table class="table">
                <tbody>
                    <tr>
                        ...
                        <?php if($info['la_regimen_select'] == 'Yes'){
                            ?>
    ...
    <?php if($info['la_regimen_select'] == 'Yes'){
        ?>
    <h5 class="pt"><b>Total Post-Procedure (Recovery) LA & Adjuvant Consumption</b></h5>
    ...
    <h6 class="pt"><b>Vasopressor Use in Post-procedure</b></h6>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    <tr>
                        <td class="bg-pat2">Vasopressor Use in Post-procedure</td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header" id="add-header">
                    <h4 class="modal-title">Edit Post-procedure</h4>
                ...
                <div class="modal-body">
                    <form id="edit-postop">
                        <div class="row">
                            <div class="col-sm-3"><label>Duration of Labour (Hours)</label></div>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="duration_labour" value="<?php echo $info['duration_labour']; ?>" name="duration_labour">
                            </div>
                            <div class="col-sm-6"></div>
                        </div><!--row-->
                        <div class="row pt-4">
                            <div class="col-sm-3"><label>Duration of First Stage (Hours)</label></div>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="duration_first" value="<?php echo $info['duration_first_stage']; ?>" name="duration_first">
                            </div>
                            <div class="col-sm-6"></div>
                        </div><!--row--> 
                        <div class="row pt-4">
                            <div class="col-sm-3"><label>Duration of Second Stage (Hours)</label></div>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="duration_secound" value="<?php echo $info['duration_secound_stage']; ?>" name="duration_secound">
                            </div>
                            <div class="col-sm-6"></div>
                        </div><!--row-->
                        <div class="row pt-4">
                            <div class="col-sm-3"><label>Oxytocin Required</label></div>
                            <div class="col-sm-3">
                                <div class= "box_1">
                                    <?php 
                                    if($info['oxyto'] == 'Yes'){
                                        ?>
                                         <input type="checkbox" name = "oxyto" class="switch_1" id="oxyto" onclick="oxytocin()" checked>
                                        <?php
                                    }
                                    else{
                                        ?>
                                        <input type="checkbox" name = "oxyto" class="switch_1" id="oxyto" onclick="oxytocin()">
                                        <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <label>Labour Outcome</label>
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                <select class="form-control" onchange="select_option()" id="labour_outcome1" name="labour_outcome1">
                                    <option value="">Select</option>
                                    <option>Normal Vaginal Delivery</option>
                                    <option>Vaginal Delivery with Instrumentation</option>
                                    <option>LSCS (Caesarean section)</option>
                                </select>
                                </div>
                                <div class="form-group labour_outcome_another" style="display:none;" >
                                <select class="form-control" id="labour_outcome2" onchange="input_field()" name="labour_outcome2" >
                                    <option value="">Select</option>
                                    <option>Foetal Distress</option>
                                    <option>Non-Progress</option>
                                    <option>Dystocia</option>
                                    <option>Other</option>
                                </select>
                                </div>
                                <input style="display:none;" type="text" class="form-control" name="labour_outcome_other[]" id="labour_outcome_other1">
                                <input style="display:none;" type="text" class="form-control" name="labour_outcome_other[]" id="labour_outcome_other2">
                                <input style="display:none;" type="text" class="form-control" name="labour_outcome_other[]" id="labour_outcome_other3">
                            </div>
                            <div class="col-sm-6"></div>
                        </div><!--row-->
                        <label class="pt-3">Foetal Outcome</label>
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4">
                                <div class="form-check">              
                                    <label class="form-check-label">
                                        <input type="hidden" class="form-check-input" value="No" name="normal">
                                        <input type="checkbox" class="form-check-input normal" value="Yes" name="normal">Normal
                                    </label>
                                </div><!----->
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="form-check-input" value="No" name="acidosis">
                                    <input type="checkbox" class="form-check-input acidosis" value="Yes" name="acidosis">Acidosis (ph < 7.2)
                                </label>
                                </div><!----->
                                <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="form-check-input" value="No" name="naloxone">
                                    <input type="checkbox" class="form-check-input naloxone" value="Yes" name="naloxone">Naloxone required
                                </label>
                                </div><!----->
                            </div>
                            <div class="col-sm-4">
                                <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="form-check-input" value="No" name="hypoglecemia">
                                    <input type="checkbox" class="form-check-input hypoglecemia" value="Yes" name="hypoglecemia">Hypoglecemia
                                </label>
                                </div><!----->
                                <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="form-check-input" value="No" name="birth_trauma">
                                    <input type="checkbox" class="form-check-input birth_trauma" value="Yes" name="birth_trauma">Birth Trauma
                                </label>
                                </div><!----->
                                <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="form-check-input" value="No" name="apgar">
                                    <input type="checkbox" class="form-check-input apgar" value="Yes" name="apgar">APGAR at 5 min < 7
                                </label>
                                </div><!----->
                                <div class="form-check">
                                <label class="form-check-label">
                                    <!-- <input type="hidden" class="form-check-input" value="No" name="foetal_other"> -->
                                    <input type="checkbox" class="form-check-input foetal_other_chick foetal_other" value="Yes" name="foetal_other" onclick = "foetal_other_field()">Other
                                </label>
                                </div> 

                                <div class="foetal_other_box" style="display:none;">
                                    <label class="form-check-label">                        
                                        <input type="text" id="foetal_other1" name="foetal_other[]" class = "foetal_other_input" style="border-radius:20px; margin: 10px 0 0 25px;">
                                    </label>
                                    <label class="form-check-label">                        
                                        <input type="text" id="foetal_other2" class = "foetal_other_input" name="foetal_other[]" style="border-radius:20px; margin: 10px 0 0 25px;">
                                    </label>
                                    <label class="form-check-label">                        
                                        <input type="text" id="foetal_other3" class = "foetal_other_input" name="foetal_other[]" style="border-radius:20px; margin: 10px 0 0 25px;">
                                    </label>
                                </div><!---->
                            </div>
                            <div class="col-sm-2"></div>
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control" value="<?php echo $info['duration_stay_hospital']; ?>" name="duration_stay_hospital" id="duration_stay_hospital">
                            </div>
                            <div class="col-sm-6"></div>
                        </div>  
                        ...
                        <div class="row" style="padding-top:15px;">
                            <div class="col-sm-4"><label>Time Spent in Post-procedure(mins)</label></div>
                            <div class="col-sm-4">
                                <input type="number" class="form-control" name="time_spent" value="<?php echo $info['time_spent']; ?>">
                            </div>
                            <div class="col-sm-4"></div>
                        </div><!--row-->
                        <h5 class="pt-3"><b>Analgesia Supplement in Post-procedure</b>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class= "box_1">
                                    <input name = "analgesia_supplement" type="checkbox" class="switch_1" id="reco" onclick="recov()">
                                </div>
                            </div>
                        </div>
                        <div class="analgesia">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="intra">
                                        <?php 
                                            ...
                                            $intra_name_dose = json_decode($zk, true);                          $intra_dose_length = 0;   
                                            foreach($intra_name_dose as $key=>$val){
                        $intra_dose_length = $intra_dose_length +1;
                                        ?>      
                                        <div class="row11">    
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label>Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="text" class="form-control intra_name" name="intra_name[]"  value="<?php echo $val['name']; ?>">&nbsp&nbsp
                                                            <label>Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="number" class="form-control intra_dose" name="intra_dose[]" value="<?php echo $val['dose']; ?>">&nbsp&nbsp
                                        ...
                                        ?>
                                    <input type="hidden" class="form-control intra_dose_length" id = "intra_dose_length"  value="<?php echo $intra_dose_length; ?>">
                                    </div><!--intra ends-->
                                    <div class="form-check" id="id">
                                        <label class="form-check-label">
                                    ...
                                    <div class="oral">
                                        <?php 
                                            ...
                                            $oral_name_dose = json_decode($zs, true);                         $oral_name_length = 0;                 
                                            foreach($oral_name_dose as $key=>$val){
                                                $oral_name_length = $oral_name_length +1;
                                        ?>      <div class="row12">
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="text" class="form-control oral_name" name="oral_name[]" value="<?php echo $val['name']; ?>">&nbsp&nbsp
                                                            <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="number" class="form-control oral_dose" name="oral_dose[]" value="<?php echo $val['dose']; ?>">&nbsp&nbsp
                                        ...
                                        ?>
                                        <input type="hidden" class="form-control oral_name_length" id = "oral_name_length"  value="<?php echo $oral_name_length; ?>">
                                    </div><!--oral ends-->
                                    <div class="form-check" id="id">
                                        <label class="form-check-label">
                                    ...
                                    <div class="tramadol">
                                        <?php 
                                            ...
                                            $tram_name_dose = json_decode($zw, true);                       $tram_name_length = 0;              
                                            foreach($tram_name_dose as $key=>$val){
                                                $tram_name_length = $tram_name_length +1;
                                        ?>      <div class="row13">
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="text" class="form-control tram_name" name="tram_name[]" value="<?php echo $val['name']; ?>">&nbsp&nbsp
                                                            <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="number" class="form-control tram_dose" name="tram_dose[]" value="<?php echo $val['dose']; ?>">&nbsp&nbsp
                                        ...
                                        ?>
                                        <input type="hidden" class="form-control tram_name_length" id = "tram_name_length"  value="<?php echo $tram_name_length; ?>">
                                    </div><!--tramadol ends-->
                                    <div class="form-check" id="id">
                                        <label class="form-check-label">
                                    ...
                                    <div class="nsa">
                                        <?php 
                                            ...
                                            $nsa_name_dose = json_decode($za, true);                       $nsa_name_length = 0;              
                                            foreach($nsa_name_dose as $key=>$val){
                                                $nsa_name_length = $nsa_name_length +1;
                                        ?>      <div class="row21">
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="text" class="form-control nsa_name" name="nsa_name[]" value="<?php echo $val['name']; ?>">&nbsp&nbsp
                                                            <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="number" class="form-control nsa_dose" name="nsa_dose[]" value="<?php echo $val['dose']; ?>">&nbsp&nbsp
                                        ...
                                        ?>
                                        <input type="hidden" class="form-control nsa_name_length" id = "nsa_name_length"  value="<?php echo $nsa_name_length; ?>">
                                    </div><!--nsa ends-->
                                    <div class="form-check" id="id">
                                        <label class="form-check-label">
                                    ...
                                    <div class="para">
                                        <?php 
                                            ...
                                            $para_name_dose = json_decode($zt, true);                        $para_name_length = 0;             
                                            foreach($para_name_dose as $key=>$val){
                                                $para_name_length = $para_name_length +1;
                                        ?>      <div class="row22">
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="text" class="form-control para_name" name="para_name[]" value="<?php echo $val['name']; ?>">&nbsp&nbsp
                                                            <label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="number" class="form-control para_dose" name="para_dose[]" value="<?php echo $val['dose']; ?>">&nbsp&nbsp
                                        ...
                                        ?>
                                        <input type="hidden" class="form-control para_name_length" id = "para_name_length"  value="<?php echo $para_name_length; ?>">
                                    </div><!--para ends-->
                                    <div class="form-check" id="id">
                                        <label class="form-check-label">
                            ...
                            <div class="regi">
                                <div class="row pt">
                                    <div class="col-sm-2"></div>
                                    <div class="col-sm-4">
                                        <select class="form-control" id="dro" name="la_regimen_select" onchange="drop()">
                                            <option value=''>Select</option>
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="other">
                                        <?php 
                                            ...
                                            $other_name_dose = json_decode($zj, true);                      $other_name_length = 0;               
                                            foreach($other_name_dose as $key=>$val){
                                                $other_name_length = $other_name_length +1;
                                        ?>      <div class="row23">
                                                    <div class="row" style="padding-top:15px;">
                                                        <div class="col-sm-12" id="id">
                                                            <label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                        ...
                                        ?>
                                        <input type="hidden" class="form-control other_name_length" id = "other_name_length"  value="<?php echo $other_name_length; ?>">
                                    </div><!--other ends-->
                                </div>
                            </div><!--row-->
                        </div><!--analgesia ends-->
                        <h6 class="pt-4"><b>Vasopressor Use in Post-procedure</b></h6>
                        <div class="row pt-2">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-2">
                                <div class= "box_1">
...
<script>
    ...
    var ab1 = '<?php echo $info['normal']; ?>';
    var ab2 = '<?php echo $info['acidosis']; ?>';
    var ab3 = '<?php echo $info['naloxone']; ?>';
    var ab4 = '<?php echo $info['hypoglecemia']; ?>';
    var ab5 = '<?php echo $info['birth_trauma']; ?>';
    var ab6 = '<?php echo $info['apgar']; ?>';
    var ab7 = '<?php echo $info['foetal_other']; ?>';
    var split_new1 = ab7.split(',');  
    
    if(ab1=="Yes"){
        $('.normal').attr("checked",true);        
    }
    if(ab2=="Yes"){
        $('.acidosis').attr("checked",true);        
    }
    if(ab3=="Yes"){
        $('.naloxone').attr("checked",true);        
    }
    if(ab4=="Yes"){
        $('.hypoglecemia').attr("checked",true);        
    }
    if(ab5 =="Yes"){
        $('.birth_trauma').attr("checked",true);        
    }
    if(ab6 =="Yes"){
        $('.apgar').attr("checked",true);        
    }

    //alert(ab7);
     if(split_new1[0] =="Yes"){
        $('.foetal_other').attr("checked",true);   
        $('#foetal_other1').val(split_new1[1]);
        $('#foetal_other2').val(split_new1[2]);
        $('#foetal_other3').val(split_new1[3]);
        $('.foetal_other_box').show();  
     }

    var ab8 = '<?php echo $info['labour_outcome1']; ?>';
    var ab8_split = ab8.split(','); 

    if(ab8_split[0] =='LSCS (Caesarean section)'){
        $('#labour_outcome1').val(ab8_split[0]);
        $('#labour_outcome2').val(ab8_split[1]);
        $('.labour_outcome_another').show();
    }else{
        $('#labour_outcome1').val(ab8_split[0]);
        $('.labour_outcome_another').hide();
    }
    if(ab8_split[1] == 'Other'){
        $('#labour_outcome2').val(ab8_split[1]);
        $('#labour_outcome_other1').val(ab8_split[2]);
        $('#labour_outcome_other2').val(ab8_split[3]);
        $('#labour_outcome_other3').val(ab8_split[4]);

        $('#labour_outcome_other1').show();
        $('#labour_outcome_other2').show();
        $('#labour_outcome_other3').show();
    ...
    function select_option(){
        var labour_outcome1 = $('#labour_outcome1').val();
        // alert(labour_outcome1);
        if(labour_outcome1 == 'LSCS (Caesarean section)'){
            $('.labour_outcome_another').show();
        }else{
            $('#labour_outcome_other').hide();
            $('.labour_outcome_another').hide();
            $('#labour_outcome2').val('');
            $('#labour_outcome_other').val('');
        }
    }

    function input_field(){
        var labour_outcome2 = $('#labour_outcome2').val();
        if(labour_outcome2 == 'Other'){
            $('#labour_outcome_other').show();
...
$(document).ready(function(){
    ...
    var i = $('#intra_dose_length').val();
    //alert(i);
    var j = $('#oral_name_length').val();
    var k = $('#tram_name_length').val();
    var l = $('#nsa_name_length').val();
    var m = $('#para_name_length').val();
    var n = $('#other_name_length').val(); 
  
	$(".add1").click(function(){
        if(i<3){
            // alert(i);
            i++;
		    $(".intra").append('<div class="row" style="padding-top:15px;"><div class="col-sm-12" id="id"><label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control intra_name" name="intra_name[]">&nbsp&nbsp<label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="number" class="form-control intra_dose" name="intra_dose[]">&nbsp&nbsp<button type="button" class="btn remove1"><i class="fa fa-times" aria-hidden="true"></i></button></div></div>');
        }
    });
    $(".add2").click(function(){
        if(j<3){
            j++;
		    $(".oral").append('<div class="row" style="padding-top:15px;"><div class="col-sm-12" id="id"><label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control oral_name" name="oral_name[]">&nbsp&nbsp<label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="number" class="form-control oral_dose" name="oral_dose[]">&nbsp&nbsp<button type="button" class="btn remove2"><i class="fa fa-times" aria-hidden="true"></i></button></div></div>');
        }
    });
    $(".add3").click(function(){
        if(k<3){
            k++;
		    $(".tramadol").append('<div class="row" style="padding-top:15px;"><div class="col-sm-12" id="id"><label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control tram_name" name="tram_name[]">&nbsp&nbsp<label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="number" class="form-control tram_dose" name="tram_dose[]">&nbsp&nbsp<button type="button" class="btn remove3"><i class="fa fa-times" aria-hidden="true"></i></button></div></div>');
        }
    });
    $(".add4").click(function(){
        if(l<3){
            l++;
		    $(".nsa").append('<div class="row" style="padding-top:15px;"><div class="col-sm-12" id="id"><label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control nsa_name" name="nsa_name[]">&nbsp&nbsp<label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="number" class="form-control nsa_dose" name="nsa_dose[]">&nbsp&nbsp<button type="button" class="btn remove4"><i class="fa fa-times" aria-hidden="true"></i></button></div></div>');
        }
    });
    $(".add5").click(function(){
        if(m<3){
            m++;
		    $(".para").append('<div class="row" style="padding-top:15px;"><div class="col-sm-12" id="id"><label >Name&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" class="form-control para_name" name="para_name[]">&nbsp&nbsp<label >Dosage&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="number" class="form-control para_dose" name="para_dose[]">&nbsp&nbsp<button type="button" class="btn remove5"><i class="fa fa-times" aria-hidden="true"></i></button></div></div>');
        }
    });
    $(".add6").click(function(){
        if(n<3){
...
function recov(){
    ...
    if(!reco){
        ...
        if(opi){
            toastr.error('Please remove Intravenous Opioids..');
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(ora){
            toastr.error('Please remove Oral Opiodis ..');
           
            $('#reco').attr("checked",true);
            document.getElementById("reco").checked = true;
        }
        else if(tra){
            toastr.error('Please remove Tramadol ..');
            ...
            toastr.error('Please remove NSAID ..');
            ...
            toastr.error('Please remove Paracetemol  ..');
            ...
            toastr.error('Please remove LA Regimen  ..');
        ...
        // $('.nsa').hide();
        // $('.para').hide();
        // $('#opi').attr("checked",false);
        // $('#ora').attr("checked",false);
        // $('#tra').attr("checked",false);
        // $('#nid').attr("checked",false);
        // $('#temo').attr("checked",false);
...
$('#edit-postop').submit(function(e){
    ...
    $.ajax({
        type : "POST",
        url : '<?php  echo base_url("editPostop-labour")?>',
        data : formData,
        contentType: false,
        processData: false,
