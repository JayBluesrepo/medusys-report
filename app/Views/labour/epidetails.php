                ...
                <table class="table">
                    <tbody>
                         ...
                         <tr>
                            ...
                            echo 'Date : '.$new_date.'   Time: '.$info['time']; ?></td>
                        </tr> 
                        <tr>
            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr><td class="bg-pat2">Other</td>
                            <?php if($info['tc_other'] != 'Yes'){ ?>
                                <td>No</td> 
                            <?php }
                                else{ ?>
                                <td >Yes - <?php echo $info['other5']; ?></td>
                            <?php }; ?>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        ...
                        <tr><td class="bg-pat2">Other</td>
                            <?php if($a_other){ ?>    
                                <td>No</td>
                            <?php }else{ ?>
                                <td>Yes - <?php echo $info['other2']; ?></td>
                            <?php }; ?> 
                        </tr>
                    </tbody>
                </table>
                                ...
                                <div class="acute">
                                   ...
                                   <!--  <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <!-- <input type="hidden" class="switch_1" value="No" name="ac_cardiac_arrest"> -->
                                            <input type="checkbox" class="form-check-input foetal_CTG" id = "foetal_CTG" value="Yes" name="foetal_CTG">Acute Foetal CTG Changes / Deceleration needing intervention
                                        </label>
                                    </div>
...
$(document).ready(function(){
    ...
    if(qqq != ''|| vcs != ''|| qrq != ''|| mm != ''|| mu != ''|| qvc != ''|| qtq == 'Yes'){
    ...
    var yy = "<?php echo $info['maternal_fever']; ?>";
    var zz = "<?php echo $info['foetal_CTG']; ?>";
    // var xz = "<?php echo $info['ac_none']; ?>";


    if((xc == "Yes")||(xa == "Yes")||(xb == "Yes")||(xd == "Yes")||(xe == "Yes")||(xf == "Yes")
    ||(xg == "Yes")||(xh == "Yes")||(xj == "Yes")||(xk == "Yes")||(xl == "Yes")
    ||(xm == "Yes")||(xn == "Yes")||(xo == "Yes")||(xp == "Yes")||(xq == "Yes")||(xr == "Yes") || (yy == "Yes") || (zz == "Yes")){
...
var bb10 = "<?php echo $info['epedural_level']; ?>";
var cj = "<?php echo $info['epidural_level_name']; ?>";
$('#epidu').val(bb10);
$('#epid_type').val(cj);
if(bb10 != ''){
    $('.'+bb10+'').css("background", "red").css("color", "white");
}
...
$('#edit-epi').submit(function(e){
    ...
    if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
        ...
        if(final5[1] == 'red' || final5[3] == 'green'|| final6[1] == 'red' ||
            ...
            $.ajax({
                type : "POST",
                url : '<?php  echo base_url("editEpidu-labour")?>',
                data : formData,
                contentType: false,
                processData: false,
