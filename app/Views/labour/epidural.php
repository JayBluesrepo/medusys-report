        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <div class="acute">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="hidden" class="form-check-input" value="No" name="maternal_fever">
                    ...
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="hidden" class="form-check-input" value="No" name="foetal_CTG">
                            <input type="checkbox" class="form-check-input" id = "foetal_CTG"  value="Yes" name="foetal_CTG">Acute Foetal CTG Changes / Deceleration needing intervention
                        </label>
                    </div>
...
function acute(){
    ...
    if(!acu){
        ...
        var ac_intra_cath = $('#ac_intra_cath').is(':checked');
            ...
            if(ac_last){
                toastr.error('Please Uncheck LAST');
    ...
    $('#add-epi').submit(function(e){
        ...
        if(final5 != '' || final6 != '' ){
            ...
            if(i == 1){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("labour-addEpi")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
                    success:function(response){
                        ...
                        if(response.result==1){
                            ...
                            $('#add-epi')[0].reset();   
                            window.location = '<?php echo base_url("labour/EpiDetails")?>?id='+response.msg;     
                        }
                        else{
