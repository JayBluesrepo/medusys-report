<?php
    echo view('includes/header-labour',$patient, $post, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
<!-----------------------------------PACU START----------------------------------->
<div role="tabpanel" class="tab-pane" id="settings">
    <section class="add-pacu">
        <h3>Add Post-procedure</h3>
        <form id="add-pacu">
         <div class="row">
            <div class="col-sm-3"><label>Duration of Labour (Hours)</label></div>
            <div class="col-sm-3">
                 <input type="number" class="form-control" id="duration_labour" name="duration_labour">
             </div>
          ...
          <div class="row pt-4">
             ...
             <div class="col-sm-3">
                 <input type="number" class="form-control" id="duration_first" name="duration_first">
             </div>
             <div class="col-sm-6"></div>
         </div><!--row--> 
          <div class="row pt-4">
             ...
             <div class="col-sm-3">
                 <input type="number" class="form-control" id="duration_secound" name="duration_secound">
             </div>
             <div class="col-sm-6"></div>
         </div><!--row-->
         <div class="row pt-4">
            ...
            <div class="col-sm-4">
                <div class="form-check">              
                    <label class="form-check-label">
                        ...
                        <input type="checkbox" class="form-check-input" value="Yes" name="normal">Normal
                    </label>
                </div><!----->
               <div class="form-check">
                  <label class="form-check-label">
                    <input type="hidden" class="form-check-input" value="No" name="acidosis">
                    <input type="checkbox" class="form-check-input" value="Yes" name="acidosis">Acidosis (ph < 7.2)
                  </label>
                </div><!----->
                 <div class="form-check">
                  <label class="form-check-label">
                    <input type="hidden" class="form-check-input" value="No" name="naloxone">
                    <input type="checkbox" class="form-check-input" value="Yes" name="naloxone">Naloxone required
                  </label>
                </div><!----->
            </div>
            <div class="col-sm-4">
                <div class="form-check">
                  <label class="form-check-label">
                    ...
                    <input type="checkbox" class="form-check-input" value="Yes" name="hypoglecemia">Hypoglecemia
                  </label>
                </div><!----->
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="hidden" class="form-check-input" value="No" name="birth_trauma">
                    <input type="checkbox" class="form-check-input" value="Yes" name="birth_trauma">Birth Trauma
                  </label>
                </div><!----->
                <div class="form-check">
                  <label class="form-check-label">
                    <input type="hidden" class="form-check-input" value="No" name="apgar">
                    <input type="checkbox" class="form-check-input" value="Yes" name="apgar">APGAR at 5 min < 7
                  </label>
                </div><!----->
                <div class="form-check">
                  <label class="form-check-label">
                    <!-- <input type="hidden" class="form-check-input" value="No" name="foetal_other"> -->
                    <input type="checkbox" class="form-check-input foetal_other_chick" value="Yes" name="foetal_other" onclick="foetal_other_field()">Other
                  </label>

                  <div id="proced-plus" class="other-li foetal_other_box" style="display:none;">
        ...
        <div class="row pt-4">
            ...
            <div class="col-sm-4">
                <input type="number" class="form-control" name="duration_stay_hospital" id="duration_stay_hospital">
            </div>
            <div class="col-sm-6"></div>
        </div>   
        <h5><b>Pain Score (0-10) (0:Min,10:Max)</b></h5>
            ...
            <h5 class="pt-2"><b>Analgesia Supplement in Post-procedure</b>
            ...
            <h6 class="pt-2"><b>Vasopressor Use in Post-procedure</b></h6>
            <div class="row pt-2">
                <div class="col-sm-2"></div>
                <div class="col-sm-2">
                    <div class= "box_1">
...
<script>
    ...
    function input_field(){
        ...
        if(labour_outcome2 == 'Other'){
            ...
            $('#labour_outcome_other1').hide();
            $('#labour_outcome_other2').hide();
            $('#labour_outcome_other3').hide();
        }
    }
</script>
...
$(document).ready(function(){
    $('#add-pacu').submit(function(e){
        ...
        $.ajax({
            type : "POST",
            url : '<?php  echo base_url("labour-add-postop")?>',
            data : formData,
            contentType: false,
            processData: false,
            success:function(response){
                ...
                if(response.result==1){
                    ...
                    $('#add-pacu')[0].reset();  
                    window.location = '<?php echo base_url("labour/PacuDetails")?>?id='+response.msg;      
                }
                else
