            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        <tr>
                            <?php 
                                $original_date = $info['procedure_date'];
                                $timestamp = strtotime($original_date);
                                $new_date = date("d-m-Y", $timestamp);
                            ?>
                            <td class="bg-pat2">Procedure Date and Time</td>
                            <td><?php echo 'Date : '.$new_date.'   Time: '.$info['time']; ?></td>
                        </tr>
                        <tr>
        ...
        <div class="combined-spinal-card2">
            ...
            <div class="card-body">
                <p><?php 
                        ...
                        $str4 = '';
                        if($info['lor_saline'] != ''){
                            $str1 = $info['lor_saline']."-";
                        }
                        if($info['lor_air'] != ''){
                            $str2  = $info['lor_air']."-";
                        }
                        if($info['hanging_drop'] != ''){
                            $str3  = $info['hanging_drop']."-";
                        }
                        if($info['epidural_other'] != ''){
                            $str4  = 'Other:'.$info['epidural_other'];
                        }
            ...
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td class="bg-pat2">Ketamine with Dose(mg)</td>
                            <td><?php echo $info['aj_spinal_ketamin']; ?></td>
                        </tr>
                        <tr>
                            <td class="bg-pat2">Midazolam with Dose(mg)</td>
                            <td><?php echo $info['aj_spinal_midazolam']; ?></td>
                        </tr>
                        <tr>
                            <td class="bg-pat2">Adrenaline(Epinephrine)(mcmg)</td>
        ...
        <div class="combined-spinal-table1">
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                        <tr>
                            <td class="bg-pat2">Failure of spinal component</td>
                            <td><?php echo $info['tc_failure_spinal_component']; ?></td>
                        </tr>                         
                        <tr>
                        ...
                        <tr><?php if($info['tc_other']){ 
                                    ?>
                                    <td class="bg-pat2">Other</td>
                                    <td><?php if($info['tc_other_input'] != '')
                                                echo 'Yes : '.$info['tc_other_input'];
                                            else echo 'No'; ?></td>
                  ...
                  <!---      <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td><?php echo $info['intrathecal_migration']; ?></td>
                        </tr>
                        <tr>
                   ...
                   <!--     <tr>
                        ...
                        <tr><?php if($info['ac_other']) {
                            ?>
                                 <td class="bg-pat2">Other</td>
                                 <td><?php if($info['ac_other_input'] != '')
                                                echo 'Yes : '.$info['ac_other_input'];
                                            else echo 'No'; ?></td>
                                <?php
                            }
                            ?>                            
        ...
        <div class="combined-spinal-table1">
            <div class="table-responsive">
                <table class="table">
                    <tbody>
                         <!-- <tr>
                            <td class="bg-pat2"><?php echo $info['success'];?></td>
                            <td><?php echo $info['success_onset'];?></td>
                        </tr> -->
                ...
                <form id="combined_spinal_modal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-6" id = "consultant" style="color:red; display:none;">
                            <small class="cnbdone" style="color:red;">select the option</small>
                            <select class="form-control cnb_done_by2" id="cnb_by2" style="margin: 15px 0; width: 150px;"  name="cnb_done_by2">       
                            </select> 
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control supervision" name="supervision" onfocusout='checksupervision()' required>
                                <option value="">Select</option>
                    ...
                    <div class="row pt">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" id="cse_tech_e" name="cse_tech_e" onchange="condition()" required>
                                <option value=''>Select</option>
                   ...
                   <!--  <label class="pt"><b>Total Intra Operative LA & Adjuvant Consumption<a href="#" data-toggle="tooltip" data-placement="bottom" class="tip"  title="This includes Test Dose,Initial Dose and Total Intra Operative Use"><i class="fa fa-info-circle" aria-hidden="true"></i></a></label> -->
                    <h5 class=""><b>Total Labour LA & Adjuvant Consumption</b>
                        <div class="tooltip-4">
                           <i class="fa fa-info-circle" aria-hidden="true"></i>
                            <div class="right-4">
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                ...
                                                <input type="checkbox" class="form-check-input complication_none" value="Yes" name="complication_none">None
                                            </label>
                                        </div>
                                    </li>
                                </ul> -->
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input intrathecal_migration" value="Yes" name="intrathecal_migration">Intrathecal migration of epidural catheter
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
                            ...
                            <!-- <div class="form-check">
                                <label class="form-check-label">
                                    ...
                                    <input type="checkbox" class="form-check-input ac_none" value="Yes" name="ac_none">None
                                </label>
                            </div> -->
                        </div>
                    </div><!--row-->
...
function clean4(){
 ...
 // ----------------------------------------------------calculation conver to mg (END)---------------------------------------
   ...
   function epidural_adjuvant(){
    ...
    if((ccc)||(qqq)||(vcs)||(qrq)||(mm)||(mu)||(qvc) || (obj[0].name)){
...
function cleans6(){
    ...
    var aq1 = '<?php echo $info['tc_failure_spinal_component'] ?>';
    if(aq1 == 'Yes'){
        $('.tc_failure_spinal_component').attr('checked',true);			
    }
    ...
    if(aq == 'Yes' || ae == 'Yes' || aw == 'Yes' || au == 'Yes' || ai == 'Yes' || ap == 'Yes' ){
    ...
    var z61 = '<?php echo $info['intrathecal_migration'] ?>';
    if(z61 == 'Yes'){
        $('.intrathecal_migration').attr('checked',true);         
    } 
    ...
    if(z61 == 'Yes' || z1 == 'Yes' || z2 == 'Yes' || z3 == 'Yes' || z4 == 'Yes' || z5 == 'Yes' || z6 == 'Yes' || z7 == 'Yes' || z8 == 'Yes' || z9 == 'Yes' || z10 == 'Yes' || z11 == 'Yes' || z12 == 'Yes' || z13 == 'Yes' || z14 == 'Yes' || z15 == 'Yes' || z16 == 'Yes' || z17 == 'Yes' || z21 == 'Yes' || z22 == 'Yes'){
    ...
    $('#combined_spinal_modal').submit(function(e){
        ...
        if(final1 == '' && final2 == '' && final3 == '' && final4 == '' && final5 == '' && final6 == ''){
            ...
            if(cc && aa && bb && jj && ii && ee){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("updateSpinalEpidural-labour")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
