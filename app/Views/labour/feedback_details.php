...
<section class="edit-feedback" id="view-id">
    ...
    <h5><b>During or after the procedure,did you experience(rate the severity...)</b></h5>
    ...
    <h5 class="pt"><b>Satisfaction with Labour pain relief care</b></h5>
    <div class="pat-table2">
        <div class="table-responsive">
            <table class="table">
                <tbody>
    ...
    <div class="questions">
        <div class="card">
            <div class="card-header">
                <h5>Did you feel you had time to ask your anaesthetist,questions before your labour pain relief procedure?</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5>How satisfied were you with the information on Regional labour pain relief procedure provided by your anaesthetist?</h5>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h5>How satisfied were you from labour pain relief procedure?</h5>
            </div>
            <div class="card-body">
