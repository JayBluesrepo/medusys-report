<?php
    echo view('includes/header-labour',$patient, $pat, $pcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check);    
?>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="pre_op" style="display:none;">
                                    <td id="dr_name2"></td>
                                    <td id="content2">Pre-procedure</td>
                                ...
                                <tr class="pacu" style="display:none;">
                                    <td id="dr_name4"></td>
                                    <td id="content4">Post-procedure</td>
    ...
    <div role="tabpanel" class="tab-pane active" id="home">
        <section class="patient-details">
                ...
                <div class="col-sm-8" style="text-align: end;">
                    ...
                    <button type="button" class="btn-edit edit" style="margin:5px;" id="mob-edit">Edit</button>
                    <?php 
                        if($upload){
                    ?>
...
<script>
    ...
    $('.history').click(function(){
        ...
        $.ajax({
            type : "POST",
            url : "<?php echo base_url("History-labour")?>",
            // data : {id:id},
    ...
    $(document).ready(function(){
        $('.edit').click(function(){
            ...
            $.ajax({
                type : "POST",
                url : "<?php echo base_url("edit-patient-labour")?>",
                data : {id:id},
                success:function(response) {
                    response = jQuery.parseJSON(response);
                    if(response.result == 1){
        ...
        $('#del').click(function(){
            ...
            swal({   
                title: "Are you sure?",
                text: "Patient record will be deleted from Labour Analgesia",
            ...
            function(isConfirm){   
                if(isConfirm){ 
                    ...
                    $.ajax({
                        type : "POST",
                        url : '<?php  echo base_url("delete-patient-labour")?>',
                        ...
                        success:function(response){
                            ...
                            if(response.result==1){
                                ...
                                window.setTimeout(function() {
                                    window.location = '<?php echo base_url("labour/Dashboard")?>';
                                }, 2000);
                            }
                            else
