...
<?php
    echo view('includes/dashboard-header');    
?>
        <div class="col-sm-10" style="padding: 0;">
            <div class="dashboard-right">
                ...
                <div class="row dashboard-box">
                    <div class="col-sm-3">
                        <div class="box-1">
                            <img src="<?php echo base_url('assets/images/box-img-1.png');?>">
                     ...
                     <div class="col-sm-3">
                        <div class="box-2">
                            <img src="<?php echo base_url('assets/images/box-img-2.png');?>">
                        ...
                        <div id="home" class="container tab-pane active"><br>
                           <div class="row">
                               <div class="col-sm-3">
                                  <div class="tabs-1">
                                      <div class="tabs-img">
                                           <img src="<?php echo base_url('assets/images/tabs-img-1.png');?>"> 
                                      </div>
                                      <div class="tab-cont">
                                ...
                                <div class="col-sm-3">
                                    <div class="tabs-2">
                                      <div class="tabs-img">
                                           <img src="<?php echo base_url('assets/images/tabs-img-2.png');?>"> 
                                      </div>
                                      <div class="tab-cont">
                                ...
                                <div class="col-sm-3">
                                    <div class="tabs-3">
                                      <div class="tabs-img">
                                           <img src="<?php echo base_url('assets/images/tabs-img-3.png');?>"> 
                                      </div>
                                      <div class="tab-cont">
                               ...
                               <div class="col-sm-3">
                                    <div class="tabs-4">
                                      <div class="tabs-img">
                                           <img src="<?php echo base_url('assets/images/tabs-img-4.png');?>"> 
                                      </div>
                                      <div class="tab-cont">
                    ...
                    <div class="col-sm-4">
                       <div class="users">
                           <div class="country-users">
                                <img src="<?php echo base_url('assets/images/marker.png');?>">
                                <h5>25% India</h5>
                           </div>
                           <div class="country-users">
                                <img src="<?php echo base_url('assets/images/marker.png');?>">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="logins">
                                     <img src="<?php echo base_url('assets/images/App-icon.png');?>">
                                     <h4>App Logins</h4>
                            ...
                            <div class="col-sm-4">
                                <div class="logins-1">
                                     <img src="<?php echo base_url('assets/images/App-icon-1.png');?>">
                            ...
                            <div class="col-sm-4">
                                <div class="logins-2">
                                     <img src="<?php echo base_url('assets/images/App-icon-2.png');?>">
                                     <h4>Total sold</h4>
                                     <h5>862 <span>-18%</span></h5>
                                </div>
                            </div>
...
<?php
    echo view('includes/dashboard-footer');    
?>
