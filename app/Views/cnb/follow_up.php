<?php
    echo view('includes/header',$patient, $foll, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
...
<div role="tabpanel" class="tab-pane" id="about">
    <section class="add-follow-up">
        ...
        <form id="add-followup">
            ...
            <h5 class="mt-4"><b>Select Follow up Procedure<span class="mandat">*</span></b></h5>
...
$(document).ready(function(){
    $('#add-followup').submit(function(e){
        ...
        if(ii){
            ...
            $.ajax({
                type : "POST",
                url : '<?php  echo base_url("addFollow")?>',
                data : formData,
                contentType: false,
                processData: false,
                success:function(response){
                    ...
                    if(response.result==1){
                        ...
                        window.location = '<?php echo base_url("cnb/FollowupDetails")?>?id='+response.msg;     
                    }
                    else
