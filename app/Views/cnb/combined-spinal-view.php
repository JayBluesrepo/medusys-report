     ...
     <!--    <h4 class="pt"><b>Epidural</b></h4> -->
       ...
       <!--  <h4 class="pt"><b>Needle Brand,Type and Size</b></h4> -->
        <div class="combined-spinal-card2">
            ...
            <div class="card-body">
                <ul><?php if($needle_other){
                        ...
                        $xy = explode(' - ',$xyz);
                    ?>
                    <li><span>Other - <?php echo $xy[1] ; ?></span></li>
                    <?php }else{ ?>
                    ...
                    <?php if($needle_type){
                        ...
                        $y = explode(' - ',$x);
                    ?>
                    <li><span>Other - <?php echo $y[1] ; ?></span></li>
                    <?php }else{ ?>
        ...
        <div class="combined-spinal-card2">
            ...
            <div class="card-body">
                <p><?php echo $info['lor_saline']; ?> - <?php echo $info['lor_air']; ?> - <?php echo $info['hanging_drop']; ?> - <?php if($info['epidural_other'] != ''){ ?>Other - <?php echo $info['epidural_other']; ?> <?php } ?></p>
            </div>
        </div><!--combined-spinal-card2-->
      ...
      <!--   <h4 class="pt"><b>Epidural Depth(cm)</b></h4> -->
        ...
        <div class="combined-spinal-card2">
         ...
         <div class="combined-spinal-card2">
            ...
            <div class="card-body">
              <p><?php echo $info['test_dose']; ?></p>   
            </div>
        </div><!--combined-spinal-card2-->
      <!--   <h4 class="pt"><b>Epidural Technique</b></h4> -->
        <div class="combined-spinal-card2" style="display:none;">
            <div class="card-header">
                <ul>
                   <!--  <li><b>Epidural Technique</b></li>
                    <li><b>Depth(cm)</b></li> -->
                    ...
                    <tbody>
                       ...
                       <!--  <tr>
                        ...
                        <?php
                            ...
                            if($aj_epidural_other[0]['name'] != ''){

                        ?>
                        <tr>
                            <td class="bg-pat2">Other</td>
                            <td id="inner_field">Yes</td>
                        </tr>
                    ...
                    <tbody>
                        <!--  <tr>
                          ...
                          <tr>
                            ...
                            <td><?php echo $info['failure_spinal_compo']; ?></td>
                        </tr>                       
                        <tr>
                        ...
                        <tr><?php if($t_other){ ?>
                            ...
                            <td class="bg-pat2">Other</td>
                         <?php }else{ ?>
                            <td class="bg-pat2">Other - <?php echo $info['tc_other_input']; ?></td>
                            <?php }; ?>
                ...
                <table class="table">
                  ...
                  <!---      <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo $info['ac_intrathecal_epi_catheter']; ?></td>
                        </tr>
                        <tr>
                   ...
                   <!--     <tr>
                        ...
                        <tr><?php if($a_complication) {?>
                            <td class="bg-pat2">Other</td>
                            <?php }else{ ?>
                            <td class="bg-pat2">Other - <?php echo $info['ac_other_input']; ?></td>
                            <?php }; ?>
                  ...
                  <!--   </div> --><!--add-patient-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-check" style="display:none;">
                                <label class="form-check-label">
                                <input type="radio" class="form-check-input" value="GA" name="patient_status_e" id="ga_e" onclick="hide()" >GA
                                </label>
                            </div>
                            <?php } else{ ?>
                                <div class="form-check">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-check" id="proced-plus" style="display:flex;">
                                ...
                                <div class="other_input" style="display:none;">
                                    ...
                                    <div class="other9 mt-2" id="other_input">
                                            <?php 
                   ...
                   <!--  <label class="pt"><b>Total Intra Operative LA & Adjuvant Consumption<a href="#" data-toggle="tooltip" data-placement="bottom" class="tip"  title="This includes Test Dose,Initial Dose and Total Intra Operative Use"><i class="fa fa-info-circle" aria-hidden="true"></i></a></label> -->
                    ...
                    <div class="row pt">
						...
						<h5><b>Adjuvant</b></h5>
						<div class= "box_1 p-3">
							<input type="checkbox" class="switch_1 epidural_adjuvant" id = "epidural_adj" onclick="epidural_adjuvant()">
						</div>
                        ...
                        <div class="col-sm-10">
                            <div class="pt" id="proced-plus" style="border: 1px solid lightgrey;border-radius: 8px;padding: 10px;">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input spinal_tramadol" value="">Ketamine with Dose(mg)
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-7"><input type="text" class="form-control spinal_tramadol_input" name="spinal_tramadol_dose" placeholder="mg" readonly></div>
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input spinal_tramadol" value="">Midazolam with Dose(mg)
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-sm-7"><input type="text" class="form-control spinal_tramadol_input" name="spinal_tramadol_dose" placeholder="mg" readonly></div>
				    ...
				    <label class="pt">Analgesia supplementation required
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="hidden" class="switch_1" value="No" name="ac_intrathecal_epi_catheter">
                                    <input type="checkbox" class="form-check-input ac_intrathecal_epi_catheter" value="Yes" name="ac_intrathecal_epi_catheter">Intrathecal migration of epidural catheter
                                </label>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label">
...
<script>
    ...
    function checkasep(){
		...
		// alert(wearing);
        if(wearing == true || sterile == true || hand == true || drap == true){
            $('.asep').hide();
        }
	}
</script>
...
<script>  
    ...
    if(!acu){
        ...
        var ac_intrathecal_epi_catheter = $('.ac_intrathecal_epi_catheter').is(':checked');
        ...
        var ac_intrathecal_epi_catheter = $('.ac_intrathecal_epi_catheter').is(':checked'); 
            ...
            else if(ac_intrathecal_epi_catheter){
...
function clean4(){
 ...
 // ----------------------------------------------------calculation conver to mg (END)---------------------------------------
    ...
    var ccc101 = "<?php echo $info['opioid_name']; ?>";
    var ccc = ccc101.split(",");
    ...
    var qtq110 = '<?php echo $info['aj_epidural_other']; ?>';
    var qtq = jQuery.parseJSON(qtq110); 

    if((ccc[0] != '')||(qqq)||(vcs)||(qrq)||(mm)||(mu)||(qvc)||qtq[0]['name'] != ''){
...
function cleans6(){
    ...
    var aq120 = '<?php echo $info['failure_spinal_compo'] ?>';
    if(aq120 == 'Yes'){
    ...
    var z200 = '<?php echo $info['ac_intrathecal_epi_catheter'] ?>';

    if(z200 == 'Yes'){
        $('.ac_intrathecal_epi_catheter').attr('checked',true);			
    }
    ...
    $('#combined_spinal_modal').submit(function(e){
        ...
        if(i == 1){
            ...
            if((aa) && (bb) && (cc) && (dd) && (ee) && (ii) && jj){
                ...
                $.ajax({
                    type : "POST",
                    url : '<?php  echo base_url("updateSpinalEpidural")?>',
                    data : formData,
                    contentType: false,
                    processData: false,
