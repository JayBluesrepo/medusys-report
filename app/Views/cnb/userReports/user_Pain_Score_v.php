...
<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">PACU Outcomes - Pain Scores - Arrival</h3>
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">PACU Outcomes - Pain Scores - After 30min</h3>
		...
		<div class="col-sm-9"  >
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">PACU Outcomes - Pain Scores - After 1 hr</h3>
	...
	<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
		...
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Pain Scores - Arrival Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
			...
			function drawChart() {
				...
				var options = {
					title: 'Pain Scores - After30min Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
			...
			function drawChart() {
				...
				var options = {
					title: 'Pain Scores - After 1 hr Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
