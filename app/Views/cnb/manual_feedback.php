<?php
    echo view('includes/header',$patient, $feed, $feedcheck, $preo, $posto, $follo, $proccheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
<section>
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    if(response.result==1){
                        ...
                        window.location = '<?php echo base_url("cnb/Feedback")?>?id='+response.msg;       
                    }
                    else
