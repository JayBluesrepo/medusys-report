<?php
    echo view('includes/header',$patient, $foll, $follcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus, $allcheck, $old_check, $old_check);    
?>
...
$('#edit-followup').submit(function(e){
    ...
    $.ajax({
        type : "POST",
        url : '<?php  echo base_url("editFollowup")?>',
        data : formData,
        contentType: false,
        processData: false,
