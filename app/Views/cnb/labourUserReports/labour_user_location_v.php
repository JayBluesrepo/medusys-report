	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
            ...
            <div class="reports-right pt-4">
				...
				<div class="col-sm-9" id="reports-pdf">
		                <h3 class="mt-2 pt-4">Surgery Details - Surgical location</h3>
		...
		<div id="dashboard_div" style="width: 80% auto;">
...
<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Surgical location Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				...
				column_chart.draw(data, options);
				 ...
				 //google.visualization.events.addListener(table_chart, 'ready');
				...
				var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('Surgical location.pdf');
					});
