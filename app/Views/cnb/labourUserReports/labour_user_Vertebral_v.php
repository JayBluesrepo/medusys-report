	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">Other Procedure Characteristics - Vertebral Interspace Level</h3>
...
<h4>Total cases = <?php echo $total;?></h4>
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">OTHER PROCEDURE CHARACTERISTICS - Vertebral Interspace Level(Epidural Level Name)</h3>
