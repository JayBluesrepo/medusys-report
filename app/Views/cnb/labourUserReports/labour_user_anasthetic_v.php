	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">Surgery Details - Anaesthetist Experience</h3>
								...
								<h4>Total cases = <?php echo $total;?></h4>
							        			<table class="table table-bordered" style="height: 200px; width: 100%" id="mytable">
							        				...
							        				<tbody>
														...
														<?php foreach($cnb_done_by2 as $row){
														?>
															<tr>
			...
			function drawChart() {
				...
				var data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($cnb_done_by2  as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options = {
					title: 'Anaesthetist Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
