		...
		<div class="col-sm-9">
	         ...
	         <div class="reports-right  pt-4" >
				...
				<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">Other Procedure Characteristics - Approach</h3>
			...
			function drawChart() {
				...
				var data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($approach as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options = {
					title: 'Approach Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
