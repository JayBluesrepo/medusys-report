...
<div class="col-sm-9" id="reports-pdf">
  ...
  <div class="reports-right pt-4">
    ...
    <h3 class="mt-4">Epidural Adjuvant - Opioid Adjuvant</h3>
...
>
    ...
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Clonide Adjuvant</h3>
    ...
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Dexmeditomidine Adjuvant</h3>
    ...
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Dexamephasone Adjuvant</h3>
    ...
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Tramadol Adjuvant</h3>
    ...
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Ketamine Adjuvant</h3>
    ...
    <!-- ---------------------------midazolam ADJUVANT---------------------- -->
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Midazolam Adjuvant</h3>
    ...
    <!-- ---------------------------other ADJUVANT---------------------- -->
    <div id="chart_div"></div>
    <h3 class="mt-4">Epidural Adjuvant - Other Adjuvant</h3>
...
<script>
  ...
  function drawChart() {
  	...
  	// table_chart.draw(tramadol_data, tramadol_options);
               ...
               var kepamine_data1 = google.visualization.arrayToDataTable([
                   ['Characteristics', 'Stats'],
                   <?php
  	...
  	var kepamine_data = google.visualization.arrayToDataTable([
                   ['Characteristics', 'Count'],
                   <?php
  				foreach ($kepamine as $row){
                               echo "['".$row['day']."',".$row['sell']."],";
                           } ?>
  	]);
  	var kepamine_options = {
                   title: 'Kepamine Adjuvant',
  		curveType: 'function',
  		legend: {
                       position: 'top'
  		}
  	...
  	// var table_chart = new google.visualization.Table(document.getElementById('kepamine_GoogleTableChart1'));
  	// table_chart.draw(kepamine_data1, kepamine_options);

  	var pie_chart = new google.visualization.PieChart(document.getElementById('kepamine_GoogleLineChart'));
  	pie_chart.draw(kepamine_data, kepamine_options);

  	// var table_chart = new google.visualization.Table(document.getElementById('kepamine_GoogleTableChart'));
  	// table_chart.draw(kepamine_data, kepamine_options);
  	...
  	var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('epiduraladjuvant.pdf');
					});
