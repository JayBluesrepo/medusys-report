<?php
    echo view('includes/v-reports-header');    
?>
...
<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">Adjuvant Usage - Component Adjuvant</h3>
					...
					<div class="row">
						...
						<br/>
					<div class="row">
							<div class=" col-sm-7 table-responsive" id="demo-table">
							<h4>Total cases = <?php echo $total;?></h4>
							<table class="table table-bordered" style="height: 300px; width: 100%" id="mytable">
							<thead>
							<tr>
								<th>CNB Adjuvant</th>
								<th>n</th>
				        ...
				        <div class="row">
							<div class="col-sm-6">
								<div id="GoogleLineChart" style="height: 400px; width: 100%"></div></div>
							<!-- </div>
							<div class="row"> -->
								<div class="col-sm-6">
								<div id="GoogleBarChart" style="height: 400px; width: 100%"></div></div>
							</div>	
						</br>
	    </div>
</div>
				...
				var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('ComponentAdjuvant.pdf');
					});
