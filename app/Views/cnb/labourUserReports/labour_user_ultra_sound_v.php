...
<!-- <link rel="stylesheet" type="text/css"  href="<?php echo base_url('assets/css/simpleMobileMenu-2.css'); ?>"/> -->
		...
		<div class="col-sm-9" id="reports-pdf">
                <h3 class="mt-2 pt-2">PROCEDURE CHARACTERISTICS - Ultrasound Use & Image Quality</h3>
		...
		<div class="row" id="demo-table">
		        ...
		        <div class="row" id="demo-table">
		        		...
		        		<div class="table-responsive">
		        			<table class="table table-bordered">
		        				...
		        				<tbody>
									...
									<?php foreach($image_quality as $row){
									?>
										<tr>
										<td id="report-td-bg"><p>
											<?php echo $row['day']; ?></p>
					...
					<div class="col-sm-5">
								<div id="ultra_GoogleBarChart" style="height: 400px; width: 100%"></div>
							</div>
		        	<div class="col-sm-5">
		        		
				<div id="Googleimage_qualityChart" style="height: 400px; width: 100%"></div>
		        	</div>
				</div>
		        	<div class="col-sm-2"></div>
		        </div><!--row--->
		...
		<script>
			...
			function drawChart() {
				...
				var data1 = google.visualization.arrayToDataTable([
					['ASA', 'Count'],
						<?php 
							foreach ($image_quality as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options1 = {
					title: 'CNB Ultrasound Image Quality',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				};
				var pie_chart1 = new google.visualization.PieChart(document.getElementById('Googleimage_qualityChart'));
				pie_chart1.draw(data1, options1);

				var column_chart1 = new google.visualization.ColumnChart(document.getElementById('ultra_GoogleBarChart'));
				column_chart.draw(data1, options1);
