		...
		<div class="col-sm-9"  id="reports-pdf">
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">PACU Outcomes - Nausea and Vomiting Scores(Arrival)</h3>
	...
	<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
		...
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Nausea and Vomiting Scores - Arrival Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
			...
			function drawChart() {
				...
				var options = {
					title: 'Nausea and Vomiting Scores - After30min Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
			...
			function drawChart() {
				...
				var options = {
					title: 'Nausea and Vomiting Scores - After 1 hr Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
