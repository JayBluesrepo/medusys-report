		...
		<div class="col-sm-9" id="reports-pdf">
	         ...
	         <div class="reports-right pt-4" >
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">Epidural Technique(Single Shot)</h3>
...
<h3>Report Details</h3>
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">Epidural Technique(Cather Mark)</h3>
...
<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
		...
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Epidural Technique(Single Shot) Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
		...
		<script>
			...
			function drawChart() {
				...
				var data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($cath_mark as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options = {
					title: 'Epidural Technique(Cather Mark)',
					curveType: 'function',
					legend: {
						position: 'top'
					}
