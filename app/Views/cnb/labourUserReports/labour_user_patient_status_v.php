...
<!-- <link rel="stylesheet" type="text/css"  href="<?php echo base_url('assets/css/simpleMobileMenu-2.css'); ?>"/> -->
		...
		<div class="col-sm-9" id="reports-pdf">
                <h3 class="mt-2 pt-2">Surgery Details - Patient Status During Procedure</h3>
		...
		<br/>
		        	...
		        	<div class="col-sm-6">
		        		...
		        		<div class="table-responsive" >
		        			<table class="table table-bordered">
		        				<thead>
		        					<tr>
		        						<th>Patient Status during Block</th>
		        						<th>n</th>
		        						<th>Percentage</th>
		        					</tr>
		        				</thead>
		       ...
		       <div class="row">	
				...
				<div class="col-sm-6">	
					<div id="GoogleBarChart9" style="height: 400px; width: 100%"></div>
		        </div>
		       </div>
...
<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>
		...
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Patient Status Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				...
				var column_chart = new google.visualization.ColumnChart(document.getElementById('GoogleBarChart9'));
				...
				var data1 = google.visualization.arrayToDataTable([
					['ASA', 'Count'],
						<?php 
							foreach ($patient_position as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options1 = {
					title: 'patient_position Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				...
				var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('patient_status.pdf');
					});
