	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
		...
		<div class="col-sm-9">
			...
			<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">Other Procedure Characteristics - Number of Attempts</h3>
...
<h4>Total cases = <?php echo $total;?></h4>
        			<table class="table table-bordered" style="height: 200px; width: 100%" id="mytable">
        				...
        				<tbody>
							...
							<?php foreach($no_attempts as $row){
							?>
								<tr>
			...
			function drawChart() {
				...
				var data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($no_attempts as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options = {
					title: 'Number of Attempts Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
