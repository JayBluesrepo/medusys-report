	...
	<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/morris.js/0.5.1/morris.css">
		...
		<div class="col-sm-9" >
			...
			<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-mt-2 pt-2">Surgery Details - Patient Position During CNB</h3>
...
<table class="table table-bordered" style="height: 200px; width: 100%" id="mytable">
        				...
        				<tbody>
							...
							<?php foreach($patient_position as $row){
							?>
								<tr>
	...
	<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>	
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Patient position during CNB Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				...
				var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('patientPosition.pdf');
					});
