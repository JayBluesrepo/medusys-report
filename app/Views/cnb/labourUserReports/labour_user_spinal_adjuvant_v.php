		...
		<div class="col-sm-9">
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Opioid Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Clonide Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Dexmeditomidine Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Dexamephasone Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Tramadol Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - ketamine Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <!-- ---------------------------midazolam ADJUVANT---------------------- -->
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Midazolam Adjuvant</h3>
			...
			<tbody>
				...
				<td>
					...
					<br/> 
                     ...
                     <!-- ---------------------------adrenaline ADJUVANT---------------------- -->
                     <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Adrenaline Adjuvant</h3>
...
<h5>Reported BY:<span id="reported_by"><?php $name =  session()->get('name');  
			...
			<tbody>
				...
				<td>
                    ...
                    <!-- ---------------------------other ADJUVANT---------------------- -->
                    <div id="chart_div"></div>
                	<h3 class="mt-4">Spinal Adjuvant - Other Adjuvant</h3>
				...
				var btnSave = document.getElementById('save-pdf');
  				...
  				btnSave.addEventListener('click', function () {
					...
					html2canvas($('#reports-pdf').get(0)).then(function(canvas) {
						...
						pdfDoc.save('spinaladjuvant.pdf');
					});
