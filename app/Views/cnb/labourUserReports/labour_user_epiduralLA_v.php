...
<div class="col-sm-9" id="reports-pdf">
                	<h3 class="mt-2 pt-2">LA Utilisation - Epidural LA </h3>
        				...
        				<thead>
        					<tr>
        						<th>Plain Local Anasthesia Solution</th>
        						<th>n</th>
        						<th>Percentage</th>
        					</tr>
        				</thead>
	...
	<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>	
		<script>
			...
			function drawChart() {
				...
				var options = {
					title: 'Epidural LA Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
			...
			function drawChart() {
				...
				var data11 = google.visualization.arrayToDataTable([
					['Epidural LA without adrenaline', 'Count'],
						<?php 
				...
				var options = {
					title: 'Epidural LA without adrenaline Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
