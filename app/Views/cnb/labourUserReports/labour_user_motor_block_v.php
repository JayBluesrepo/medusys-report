		...
		<div class="col-sm-9" id="reports-pdf">
	         ...
	         <div class="reports-right pt-4" >
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">Sensory & Motor Block - Motor Block Bromage Score</h3>
        			...
        			<table class="table table-bordered" style="height: 200px; width: 100%" id="mytable">
        				...
        				<tbody>
							...
							<?php foreach($ac_motor_block as $row){
							?>
								<tr>
			...
			function drawChart() {
				...
				var data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($ac_motor_block as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var options = {
					title: 'Motor Block Bromage Score Classification',
					curveType: 'function',
					legend: {
						position: 'top'
					}
