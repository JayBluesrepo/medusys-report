		...
		<div class="col-sm-9" id="reports-pdf">
	         ...
	         <div class="reports-right pt-4">
				...
				<div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Opioid Adjuvant</h3>
        ...
        <h5>
          ...
          >
			...
			<tbody>
				...
				<td>
					<p><?php echo $total12; ?></p>
				</td>
				<td>
					<p><?php echo $o_perc2; ?></p>
				</td>
				</tr>
				<tr>
				<td>
				...
				<td>
					<p><?php echo $total11; ?></p>
				</td>
				<td>
					<p><?php echo $o_perc1; ?></p>
				</td>
				</tr>
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Clonide Adjuvant</h3>
			...
			<tbody>
				...
				<td>
					<p><?php echo $c_perc1; ?></p>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="clonidina_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/>  
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Dexmeditomidine Adjuvant</h3>
		
						<br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="dexmeditomidine_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $de_perc1; ?></p>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="dexmeditomidine_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/>  
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Dexamephasone Adjuvant</h3>
		
						<br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="dexamephasone_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $da_perc1; ?></p>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="dexamephasone_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/>  
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Tramadol Adjuvant</h3>
		
						<br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="tramadol_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $t_perc1; ?></p>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="tramadol_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/>  
                    ...
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - ketamine Adjuvant</h3>
                    
                    <br/>
                    <div class="row">
                        <div class="col-sm-5">
                            <div id="ketamine_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $total62; ?></p>
				</td>
				<td>
					<p><?php echo $k_perc2; ?></p>
				</td>
				</tr>
				<tr>
				<td>
				...
				<td>
					<p><?php echo $total61; ?></p>
				</td>
				<td>
					<p><?php echo $k_perc1; ?></p>
				</td>
				</tr>
						...
						<div class="row">
                            <div class="col-sm-5">
                                <div id="ketamine_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/>  
                    ...
                    <!-- ---------------------------midazolam ADJUVANT---------------------- -->
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Midazolam Adjuvant</h3>
                    
                    <br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="midazolam_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $total72; ?></p>
				</td>
				<td>
					<p><?php echo $m_perc2; ?></p>
				</td>
				</tr>
				<tr>
				<td>
				...
				<td>
					<p><?php echo $total71; ?></p>
				</td>
				<td>
					<p><?php echo $m_perc1; ?></p>
				</td>
				</tr>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="midazolam_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/> 
                     ...
                     <!-- ---------------------------adrenaline ADJUVANT---------------------- -->
                     <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Adrenaline Adjuvant</h3>
                    
                    <br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="adrenaline_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $a_perc1; ?></p>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="adrenaline_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/> 
                    ...
                    <!-- ---------------------------other ADJUVANT---------------------- -->
                    <div id="chart_div"></div>
                	<h3 class="mt-4">CSA Adjuvant - Other Adjuvant</h3>
                    
                    <br/>
						<div class="row">
							<div class="col-sm-5">
								<div id="other_GoogleTableChart1" style="height: 200px; width: 100%"></div>
							</div>
							<div class="col-sm-5 table-responsive" id="demo-table">
			<table
			class="table table-bordered"
			...
			<tbody>
				...
				<td>
					<p><?php echo $total82; ?></p>
				</td>
				<td>
					<p><?php echo $oth_perc2; ?></p>
				</td>
				</tr>
				<tr>
				<td>
				...
				<td>
					<p><?php echo $total81; ?></p>
				</td>
				<td>
					<p><?php echo $oth_perc1; ?></p>
				</td>
				</tr>
						...
						<div class="row">
							<div class="col-sm-5">
								<div id="other_GoogleLineChart" style="height: 400px; width: 100%"></div>
							</div>
						</div>
					<br/> 
       		 </div>
	...
	<script  src="https://html2canvas.hertzen.com/dist/html2canvas.js"></script>	
		<script>
			...
			function drawChart() {
                ...
                var ketamine_data1 = google.visualization.arrayToDataTable([
                    ['Characteristics', 'Stats'],
                    <?php 
				...
				var ketamine_data = google.visualization.arrayToDataTable([
                    ['Characteristics', 'Count'],
                    <?php 
							foreach ($ketamine as $row){
                                echo "['".$row['day']."',".$row['sell']."],";
                            } ?>
				]);
				var ketamine_options = {
                    title: 'ketamine Adjuvant',
					curveType: 'function',
					legend: {
                        position: 'top'
					}
				...
				var table_chart = new google.visualization.Table(document.getElementById('ketamine_GoogleTableChart1'));
				table_chart.draw(ketamine_data1, ketamine_options);
                
				var pie_chart = new google.visualization.PieChart(document.getElementById('ketamine_GoogleLineChart'));
				pie_chart.draw(ketamine_data, ketamine_options);
                
				// var table_chart = new google.visualization.Table(document.getElementById('ketamine_GoogleTableChart'));
				// table_chart.draw(ketamine_data, ketamine_options);


                //  ---------------------------midazolam ADJUVANT----------------------
                
                var midazolam_data1 = google.visualization.arrayToDataTable([
					['Characteristics', 'Stats'],
						<?php 
				...
				var midazolam_data = google.visualization.arrayToDataTable([
					['Characteristics', 'Count'],
						<?php 
							foreach ($midazolam as $row){
							   echo "['".$row['day']."',".$row['sell']."],";
						} ?>
				]);
				var midazolam_options = {
					title: 'Midazolam Adjuvant',
					curveType: 'function',
					legend: {
						position: 'top'
					}
				...
				var table_chart = new google.visualization.Table(document.getElementById('midazolam_GoogleTableChart1'));
				table_chart.draw(midazolam_data1, midazolam_options);

				var pie_chart = new google.visualization.PieChart(document.getElementById('midazolam_GoogleLineChart'));
				pie_chart.draw(midazolam_data, midazolam_options);

				// var table_chart = new google.visualization.Table(document.getElementById('midazolam_GoogleTableChart'));
				// table_chart.draw(midazolam_data, midazolam_options);
