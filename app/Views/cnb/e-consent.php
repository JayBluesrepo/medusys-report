<?php
    echo view('includes/header',$patient, $eco, $preo, $posto, $follo, $proccheck, $feedcheck, $focus, $allcheck, $old_check, $old_check);    
?>                	 	
		...
		$.ajax({
			...
			success:function(response){
                ...
                if(response.result==1){
					...
					window.location = '<?php echo base_url("cnb/E_consentView")?>?id='+response.msg;                  
                }
                else {
