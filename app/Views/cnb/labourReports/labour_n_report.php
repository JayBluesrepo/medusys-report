...
<div class="col-sm-9">
  ...
  <div class="reports-right pt-4"    >
    ...
    <h3 class="mt-2 pt-2">Audit Result</h3>
  ...
  <div class="consolidated-results">
    ...
    <div class="table-cont">
      ...
      <p>2) N' includes following scenarios of data entered by labour</p>
      <ul>
      ...
      <p>Nc includes following scenario of data entered by labour</p>
      <ul>
