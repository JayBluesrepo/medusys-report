...
<div class="col-sm-9" id="reports-pdf"  >
    ...
    <input type="date"   class="form-control from_date"  name="from_date" value="<?php echo date('d-m-Y',strtotime(session()->get('from_date'))); ?>" >
    </div>
    <div class="col-sm-5">
    <label><b>To Date:</b></label>
    <input type="date"   class="form-control to_date"  name="to_date"  value="<?php echo date('d-m-Y',strtotime(session()->get('to_date'))); ?>">
    </div>
