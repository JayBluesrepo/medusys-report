	...
	<h3>Add Combined Spinal Epidural</h3>
			<form id="combined_spinal_epidural_block">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="form-check">
							...
							<input type="radio" class="form-check-input" id='option-1' value="Awake" name="neuraxial_block" onclick="hide()">Awake
							</label>
						</div>
						<div class="form-check">
							<label class="form-check-label">
							<input type="radio" class="form-check-input" id='option-2' value="Sedation" name="neuraxial_block" onclick="show()">Sedation
							</label>
						</div>
								...
								<li>
									<div class="togle">
										...
										<div class= "box_1">
											...
											<input type="checkbox" class="switch_1" value="Yes" id="wearing_mask" name="wear_mask" onclick="checkasep()">
										</div>
									</div>
								</li>
								<li>
				...
				<div class="row pt">
					...
					<!-- <small class="csacheck" id="csa" style="color:red; display:none;">please enter cse</small> -->
				</div><!--row-->
				...
				<div class="row">
					...
					<div class="col-sm-8">
						...
						<div class="pt catheter_fild" style="display:flex; display:none;">
							...
							<input type="number" class="form-control" name="epidural_catheter"  style="width:30%;margin-top: 10px;">
						</div>
					</div>
								...
								<div class="form-check" style="margin-left: 3%;">
									...
									<div class="form-check" style="margin-left: 3%;">
										<label class="form-check-label">
											...
											<input type="checkbox" class="form-check-input spinal_adju" value="Yes" name="asr_other_iv">Other IV Adjuvants
										</label>
									</div>
						...
						<div class="spinal_acute_multi_option_box" style="display:none;">
							...
							<div class="form-check" style="display: flex;">
								<label class="form-check-label">
									...
									<input type="checkbox" class="form-check-input spinal_acute_other" id="ac_other" value="Yes" name="ac_other">Other
								</label>
		...
		$('#combined_spinal_epidural_block').submit(function(e){
            ...
            if(i == 1){
				...
				if((aa) && (bb) && (cc) && (dd) && (ee) && (ii)){
					...
					$.ajax({
						type : "POST",
						url : '<?php  echo base_url("add-combined-procedure")?>',
						data : formData,
						contentType: false,
						processData: false,
						success:function(response){
							...
							if(response.result==1){
								...
								window.location = '<?php echo base_url("cnb/combinedSpinalView")?>?id='+response.msg;					
							}
							else{
