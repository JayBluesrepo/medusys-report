...
class obstetrics_EFeedbackModel extends Model
{
    protected $table ='obstetrics_e_feedback';
    ...
    'similar_op_again','overall_satisfaction','any_suggestions','created_by','created_at','submission','flag','track','updated_at','updated_by','upload_patient_status'];
}
?>