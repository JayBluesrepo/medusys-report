...
class labour_SpinalModel extends Model
{
    protected $table ='labour_procedure_spinal';
    protected $allowedFields = ['id','dr_id','patient_id','procedure_date','time','cnb1','cnb2','supervision','patient_status','patient_position','wearing_mask','hand_washing','sterile_gown','sterile_draping','skin_prepartion','anatomical_landmark','spinal_level','spinal_level_name','needle_brand','other4','needle_type','other6','needle_size','approach','no_attempts',
    'la_lignocaine','la_ropivacaine','la_bupivacaine','la_prilocaine','la_2_chloroprocaine','la_otheraine','opioid_name','opioid_dose','clonidina_dose','dexmeditomidine_dose','dexamephasone_dose','tramadol_dose','ketamine_dose','midazolam_dose','adrenaline_dose','other7','aj_name','aj_dose','in_analgesia',
    ...
    'ultra_sound','probe_cover','image_quality','maternal_fever','foetal_CTG'];
}
?>
