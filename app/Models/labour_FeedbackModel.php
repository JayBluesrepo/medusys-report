...
class labour_FeedbackModel extends Model
{
    protected $table ='labour_manual_feedback';
    ...
    'similar_op_again','overall_satisfaction','any_suggestions','created_by','created_at','flag','updated_at','updated_by','upload_patient_status','anaesthesia_satisfaction'];
}
?>