...
class Epidural extends BaseController
{
    ...
    public function index()
    {
        ...
        $model2 = new EpiduralModel(); 
        $detail = $model2->where('patient_id',$patient_id)->first();
        $data['info'] = $detail;  
