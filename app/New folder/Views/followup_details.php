<?php
    echo view('includes/header',$patient, $foll, $follcheck, $preo, $posto, $follo, $proccheck, $feedcheck, $ecocheck, $focus);    
?>
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <td class="bg-pat2">Catheter related issues (same as PNB)</td>
...
<section class="edit-followup">
    <!-- The Modal -->
    <div class="modal" id="follow-details">
                ...
                <div class="modal-body">
                    <form id="edit-followup">
                        ...
                        <ul class="late" style="padding-left: 0;padding-top: 20px;">
                            <li><label><b>Late Complications</b></label></li>
                            <li>
                            ...
                            <div class="col-sm-10" id="follow-up-late">
                                ...
                                <div class="form-check" style="display:flex;">
                                    <label class="form-check-label" style="width:40%;">
                                        ...
                                        <input type="checkbox" class="form-check-input" value="Yes" id="perst_motor" name="perst_motor">Persistent motor deficit
                                    </label> 
                                </div><!--check3-->
                                <div class="form-check" style="display:flex;">
                                    <label class="form-check-label" style="width:40%;">
                                        <input type="hidden" class="form-check-input" value="No" name="perst_sensory">
                                        <input type="checkbox" class="form-check-input" value="Yes" id="perst_sensory" name="perst_sensory">Persistent sensory deficit
                                    </label>
                                </div><!--check4-->
                                <div class="form-check" style="display:flex;">
                                    <label class="form-check-label" style="width:40%;">
                                ...
                                <div class="form-check" style="display:flex;">
                                    <label class="form-check-label" style="width:40%;">
                                        ...
                                        <input type="checkbox" class="form-check-input" value="Yes" id="catheter" name="catheter">Catheter related issues (same as PNB)
                                    </label>
                                </div><!--check9-->
                                <div class="form-check" style="display:flex;">
                                    <label class="form-check-label" style="width:40%;">
                        ...
                        <label><b>Select Follow up Procedure</b></label>
                        <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4">
                                <div class="form-check">
...
$('#edit-followup').submit(function(e){
    ...
    $.ajax({
        type : "POST",
        url : '<?php  echo base_url("FollowupDetails/edit_followup")?>',
        data : formData,
        contentType: false,
        processData: false,
