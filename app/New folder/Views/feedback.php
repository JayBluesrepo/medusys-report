...
<div role="tabpanel" class="tab-pane" id="contact">
    <section class="feedback-manual">
        <ul class="nav nav-tabs" id="feed-tabs">
                    ...
                    <table class="table table-bordered" style="margin-top:20px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url("ManualFeedback/show_manual")?>" target="_blank" style="background-color:transparent!important;color:blue!important;text-align: center;display: block;"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a><!--<i class="fa-solid fa-file-pdf"></i>-->
                                </td>
                            </tr>
                        </tbody>
					</table>
            <?php } else{ ?>
                <li id="man"><a href="<?php echo base_url('ManualFeedback'); ?>">Add Feedback Manually</a></li>
            <?php }?>
            <?php if($rsend){ ?>
                    ...
                    <table class="table table-bordered" style="margin-top:20px;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url("E_Feedback/show_feedback")?>" target="_blank" style="background-color:transparent!important;color:blue!important;text-align: center;display: block;"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a><!--<i class="fa-solid fa-file-pdf"></i>-->
                                </td>
                            </tr>
                        </tbody>
					</table>
            <?php } else{ ?>
                <?php if($mails){ ?>
                    <li><button type="button" id="mail1" class="btn-submit">Resend E-Feedback</button></li>
                    &nbsp&nbsp<p id="show"><b>Email sent to the patient but patient have not submitted form</b></p>
            <?php }else{ ?>
                <li><button type="button" id="mail" class="btn btn-submit">Send E-Feedback</button></li>
            <?php }}?>
        </ul>
...
<script type="text/javascript">
    $('#mail').click(function(){
        $.ajax({
            url : '<?php  echo base_url("E_Feedback")?>',
    ...
    $('#mail1').click(function(){
        $.ajax({
            url : '<?php  echo base_url("E_Feedback/resend")?>',
            success:function(response){
                response = jQuery.parseJSON(response);
                if(response.result==1){
